...
JSM.FPSCounter.prototype.Get = function(a) {
    ...
    var c = b - this.start;
    c >= a &&
        ((this.current = 1e3 * (this.frames / c)),
        (this.start = b),
        (this.frames = 0));
...
JSM.AsyncRunTask = function(a, b, c, d, e) {
    ...
    if (void 0 === b || null === b) for (b = 0; b < c && !((e = a()), !e); b++);
    else {
...
JSM.ArcSin = function(a) {
    return JSM.IsGreaterOrEqual(a, 1)
        ? Math.PI / 2
        : JSM.IsLowerOrEqual(a, -1) ? -Math.PI / 2 : Math.asin(a);
};
JSM.ArcCos = function(a) {
    return JSM.IsGreaterOrEqual(a, 1)
        ? 0
        : JSM.IsLowerOrEqual(a, -1) ? Math.PI : Math.acos(a);
};
...
JSM.Coord2D.prototype.IsEqualWithEps = function(a, b) {
    return (
        JSM.IsEqualWithEps(this.x, a.x, b) && JSM.IsEqualWithEps(this.y, a.y, b)
    );
};
...
JSM.Coord.prototype.IsEqual = function(a) {
    return (
        JSM.IsEqual(this.x, a.x) &&
        JSM.IsEqual(this.y, a.y) &&
        JSM.IsEqual(this.z, a.z)
    );
};
JSM.Coord.prototype.IsEqualWithEps = function(a, b) {
    return (
        JSM.IsEqualWithEps(this.x, a.x, b) &&
        JSM.IsEqualWithEps(this.y, a.y, b) &&
        JSM.IsEqualWithEps(this.z, a.z, b)
    );
};
...
JSM.Coord.prototype.Rotate = function(a, b, c) {
    ...
    b = Math.cos(b);
    this.x =
        -a * (-a * f - e * g - d * h) * (1 - b) + f * b + (-d * g + e * h) * k;
    this.y =
        -e * (-a * f - e * g - d * h) * (1 - b) + g * b + (d * f - a * h) * k;
    this.z =
        -d * (-a * f - e * g - d * h) * (1 - b) + h * b + (-e * f + a * g) * k;
    this.x += c.x;
    this.y += c.y;
    this.z += c.z;
    return this;
...
JSM.MatrixDeterminant4x4 = function(
    a,
    b,
    c,
    d,
    ...
    var v = JSM.MatrixDeterminant3x3(f, g, h, l, m, n, q, r, s),
        u = JSM.MatrixDeterminant3x3(e, g, h, k, m, n, p, r, s);
    h = JSM.MatrixDeterminant3x3(e, f, h, k, l, n, p, q, s);
    e = JSM.MatrixDeterminant3x3(e, f, g, k, l, m, p, q, r);
    return v * a - u * b + h * c - e * d;
};
JSM.Orientation = { Invalid: 0, CounterClockwise: 1, Clockwise: 2 };
...
JSM.CoordOrientation2D = function(a, b, c) {
    ...
    return JSM.IsPositive(d)
        ? JSM.Orientation.CounterClockwise
        : JSM.IsNegative(d)
          ? JSM.Orientation.Clockwise
          : JSM.Orientation.Invalid;
};
...
JSM.GetVectorsFullAngle = function(a, b, c) {
    ...
    JSM.CoordOrientation(a, e, b, c) == JSM.Orientation.Clockwise &&
        (d = 2 * Math.PI - d);
    return d;
};
JSM.CoordOrientation = function(a, b, c, d) {
    ...
    d = d.AngleTo(a);
    JSM.IsEqual(d, Math.PI) &&
        (c == JSM.Orientation.CounterClockwise
            ? (c = JSM.Orientation.Clockwise)
            : c == JSM.Orientation.Clockwise &&
              (c = JSM.Orientation.CounterClockwise));
    return c;
};
...
JSM.MatrixMultiply = function(a, b) {
    ...
    G[8] = m * t + n * x + p * H + q * K;
    G[9] = m * w + n * y + p * I + q * L;
    G[10] = m * A + n * z + p * D + q * F;
    G[11] = m * B + n * E + p * C + q * J;
    G[12] = r * t + s * x + v * H + u * K;
    G[13] = r * w + s * y + v * I + u * L;
    G[14] = r * A + s * z + v * D + u * F;
    G[15] = r * B + s * E + v * C + u * J;
    return G;
};
...
JSM.MatrixInvert = function(a) {
    ...
    var v = b * g - c * f,
        ...
        H = m * a - p * r,
        I = n * a - p * s,
        D = v * I - u * H + t * E + w * z - A * y + B * x;
    if (JSM.IsZero(D)) return null;
    var C = [];
    C[0] = (g * I - h * H + k * E) / D;
    C[1] = (d * H - c * I - e * E) / D;
    C[2] = (r * B - s * A + a * w) / D;
...
JSM.MatrixRotation = function(a, b, c) {
    ...
    if (void 0 === c || null === c)
        ...
        l[11] = 0;
        l[12] =
            (m * (g + h) - a * (n * e + c * d)) * (1 - b) + (n * d - c * e) * k;
        l[13] =
            (n * (f + h) - e * (m * a + c * d)) * (1 - b) + (c * a - m * d) * k;
        l[14] =
            (c * (f + g) - d * (m * a + n * e)) * (1 - b) + (m * e - n * a) * k;
    }
    l[15] = 1;
    return l;
};
...
JSM.Sector2D.prototype.CoordPosition = function(a) {
    var b = a.x,
        ...
        h = this.GetLength();
    if (JSM.IsZero(h))
        return a.IsEqual(this.beg)
            ? JSM.CoordSectorPosition2D.CoordOnSectorEndCoord
            : JSM.CoordSectorPosition2D.CoordOutsideOfSector;
    a = ((b - d) * (f - d) + (c - e) * (g - e)) / (h * h);
    if (JSM.IsLower(a, 0) || JSM.IsGreater(a, 1))
        return JSM.CoordSectorPosition2D.CoordOutsideOfSector;
    e += a * (g - e);
    return !JSM.IsEqual(d + a * (f - d), b) || !JSM.IsEqual(e, c)
        ? JSM.CoordSectorPosition2D.CoordOutsideOfSector
        : JSM.IsEqual(a, 0) || JSM.IsEqual(a, 1)
          ? JSM.CoordSectorPosition2D.CoordOnSectorEndCoord
          : JSM.CoordSectorPosition2D.CoordInsideOfSector;
};
JSM.Sector2D.prototype.SectorPosition = function(a, b) {
    function c(a, b, c) {
        return !c.IsEqual(a) &&
        !c.IsEqual(b) &&
        JSM.IsLowerOrEqual(c.x, Math.max(a.x, b.x)) &&
        JSM.IsLowerOrEqual(c.y, Math.max(a.y, b.y)) &&
        JSM.IsGreaterOrEqual(c.x, Math.min(a.x, b.x)) &&
        JSM.IsGreaterOrEqual(c.y, Math.min(a.y, b.y))
            ? !0
            : !1;
    }
...
JSM.Sector.prototype.CoordPosition = function(a) {
    var b = a.x,
        ...
        m = e.y + f.y,
        n = e.z + f.z,
        p = (l - g) * (l - g) + (m - h) * (m - h) + (n - k) * (n - k);
    if (JSM.IsZero(p))
        return e.IsEqual(a)
            ? JSM.CoordSectorPosition.CoordOnSectorEndCoord
            : JSM.CoordSectorPosition.CoordOutsideOfSector;
    b = ((l - g) * (b - g) + (m - h) * (c - h) + (n - k) * (d - k)) / p;
    f = f.Clone().MultiplyScalar(b);
    e = JSM.CoordAdd(e, f);
    a = a.DistanceTo(e);
    return JSM.IsZero(a)
        ? JSM.IsLower(b, 0) || JSM.IsGreater(b, 1)
          ? JSM.CoordSectorPosition.CoordOutsideOfSector
          : JSM.IsEqual(b, 0) || JSM.IsEqual(b, 1)
            ? JSM.CoordSectorPosition.CoordOnSectorEndCoord
            : JSM.CoordSectorPosition.CoordInsideOfSector
        : JSM.CoordSectorPosition.CoordOutsideOfSector;
};
...
JSM.GetSectorSegmentation2D = function(a, b) {
    var c = JSM.CoordSub2D(a.end, a.beg),
        ...
        h;
    for (g = 0; g <= b; g++)
        (h = a.beg.Clone().Offset(c, e)), f.push(h), (e += d);
    return f;
};
...
JSM.CoordLinePosition = { CoordOnLine: 0, CoordOutsideOfLine: 1 };
...
JSM.Line2D.prototype.CoordPosition = function(a) {
    ...
    return JSM.IsPositive(a)
        ? JSM.CoordLinePosition2D.CoordAtLineLeft
        : JSM.IsNegative(a)
          ? JSM.CoordLinePosition2D.CoordAtLineRight
          : JSM.CoordLinePosition2D.CoordOnLine;
};
...
JSM.Line2D.prototype.LinePosition = function(a, b) {
    var c = this.start.x,
        ...
        g = (l - h) * (e - c) - (k - g) * (f - d);
    if (JSM.IsZero(g))
        return JSM.IsZero(m) && JSM.IsZero(n)
            ? JSM.LineLinePosition2D.LinesIntersectsCoincident
            : JSM.LineLinePosition2D.LinesDontIntersect;
    m /= g;
...
JSM.Line.prototype.CoordPosition = function(a, b) {
    ...
    if (JSM.IsZero(q))
        return (
            ...
            f.IsEqual(a)
                ? JSM.CoordLinePosition.CoordOnLine
                : JSM.CoordLinePosition.CoordOutsideOfLine
        );
    c = g
        .Clone()
        .MultiplyScalar(
            ((m - h) * (c - h) + (n - k) * (d - k) + (p - l) * (e - l)) / q
        );
    f = JSM.CoordAdd(f, c);
    void 0 !== b && b.Set(f.x, f.y, f.z);
    f = a.DistanceTo(f);
...
JSM.Line.prototype.ClosestPoint = function(a, b, c) {
    function d(a, b, c, d, e) {
        return (
            (a[b].x - a[c].x) * (a[d].x - a[e].x) +
            (a[b].y - a[c].y) * (a[d].y - a[e].y) +
            (a[b].z - a[c].z) * (a[d].z - a[e].z)
        );
    }
    ...
    g = (g + n * k) / l;
    void 0 !== b &&
        (e.MultiplyScalar(n), (e = JSM.CoordAdd(f, e)), b.Set(e.x, e.y, e.z));
    void 0 !== c &&
        (h.MultiplyScalar(g), (b = JSM.CoordAdd(a, h)), c.Set(b.x, b.y, b.z));
    return !0;
};
JSM.Line.prototype.LinePosition = function(a, b) {
    var c = new JSM.Coord(0, 0, 0),
        d = new JSM.Coord(0, 0, 0);
    return !this.ClosestPoint(a, c, d)
        ? JSM.LineLinePosition.LinesIntersectsCoincident
        : c.IsEqual(d)
          ? (void 0 !== b && b.Set(c.x, c.y, c.z),
            JSM.LineLinePosition.LinesIntersectsOnePoint)
          : JSM.LineLinePosition.LinesDontIntersect;
};
...
JSM.Box.prototype.IsCoordInside = function(a) {
    return JSM.IsLower(a.x, this.min.x) ||
    JSM.IsLower(a.y, this.min.y) ||
    JSM.IsLower(a.z, this.min.z) ||
    JSM.IsGreater(a.x, this.max.x) ||
    JSM.IsGreater(a.y, this.max.y) ||
    JSM.IsGreater(a.z, this.max.z)
        ? !1
        : !0;
};
...
JSM.BoxUnion = function(a, b) {
    var c = new JSM.Coord(
            JSM.Minimum(a.min.x, b.min.x),
            JSM.Minimum(a.min.y, b.min.y),
            JSM.Minimum(a.min.z, b.min.z)
        ),
        d = new JSM.Coord(
            JSM.Maximum(a.max.x, b.max.x),
            JSM.Maximum(a.max.y, b.max.y),
            JSM.Maximum(a.max.z, b.max.z)
        );
...
JSM.RotationXTransformation = function(a, b) {
    ...
    void 0 === b || null === b
        ? (c.matrix = JSM.MatrixRotationX(a))
        : (c.Append(
              JSM.TranslationTransformation(new JSM.Vector(-b.x, -b.y, -b.z))
          ),
...
JSM.RotationYTransformation = function(a, b) {
    var c = new JSM.Transformation();
    void 0 === b || null === b
        ? (c.matrix = JSM.MatrixRotationY(a))
        : (c.Append(
              JSM.TranslationTransformation(new JSM.Vector(-b.x, -b.y, -b.z))
          ),
...
JSM.RotationZTransformation = function(a, b) {
    var c = new JSM.Transformation();
    void 0 === b || null === b
        ? (c.matrix = JSM.MatrixRotationZ(a))
        : (c.Append(
              JSM.TranslationTransformation(new JSM.Vector(-b.x, -b.y, -b.z))
          ),
...
JSM.LinePlanePosition = { LineParallelToPlane: 0, LineIntersectsPlane: 1 };
...
JSM.Plane.prototype.CoordPosition = function(a) {
    ...
    return JSM.IsPositive(a)
        ? JSM.CoordPlanePosition.CoordInFrontOfPlane
        : JSM.IsNegative(a)
          ? JSM.CoordPlanePosition.CoordAtBackOfPlane
          : JSM.CoordPlanePosition.CoordOnPlane;
};
JSM.Plane.prototype.LinePosition = function(a, b) {
    ...
    void 0 !== b &&
        (c.MultiplyScalar((g * d + h * e + k * f + l) / m),
...
JSM.CoordPlaneSignedDirectionalDistance = function(a, b, c) {
    ...
    c = c.d;
    var l =
        g * (b - (a.x + d.x)) + h * (e - (a.y + d.y)) + k * (f - (a.z + d.z));
...
JSM.ConvexHull2D = function(a) {
    function b(a, b) {
        ...
        for (e = 1; e < c; e++)
            b == d
                ? (d = e)
                : JSM.CoordOrientation2D(a[b], a[d], a[e]) ==
                      JSM.Orientation.Clockwise && (d = e);
        return d;
    }
    var c = [];
...
JSM.ConvexHull3D = function(a) {
    ...
    function f(a, b, d, e) {
        ...
        a.tri1 != b &&
            a.tri2 != b &&
            (-1 == a.tri1 ? (a.tri1 = b) : -1 == a.tri2 && (a.tri2 = b));
        return f;
    }
    function g(a, b, c, e) {
    ...
    function l(a, b) {
        ...
        for (d = 0; d < a.triangles.length; d++)
            (e = a.triangles[d]),
                e.valid
                    ? !JSM.IsLower(
                          k(a, e.vertices[0], e.vertices[2], e.vertices[1], b),
                          0
                      )
                      ? c.push(!0)
                      : c.push(!1)
        ...
        for (d = 0; d < c.length; d++)
            c[d] &&
                ...
                e.valid &&
                    ...
                    (m = a.edges[e.edges[2]]),
                    (f =
                        -1 == f.tri1 || -1 == f.tri2 || c[f.tri1] != c[f.tri2]),
                    (l =
                        -1 == l.tri1 || -1 == l.tri2 || c[l.tri1] != c[l.tri2]),
                    (m =
                        -1 == m.tri1 || -1 == m.tri2 || c[m.tri1] != c[m.tri2]),
...
JSM.Complexity = { Invalid: 0, Convex: 1, Concave: 2, Complex: 3 };
JSM.CoordPolygonPosition2D = { OnVertex: 0, OnEdge: 1, Inside: 2, Outside: 3 };
...
JSM.Polygon2D.prototype.GetOrientation = function() {
    ...
    if (3 <= this.vertices.length) {
        ...
        JSM.IsPositive(b)
            ? (a = JSM.Orientation.CounterClockwise)
            : JSM.IsNegative(b) && (a = JSM.Orientation.Clockwise);
    }
...
JSM.Polygon2D.prototype.CoordPosition = function(a) {
    function b(a, b, c) {
        ...
        JSM.IsEqual(b.y, a.y) ||
            ((g = Math.abs((b.y - a.y) / (c.y - b.y))),
            (e.x = b.x + (c.x - b.x) * g));
        return JSM.IsLower(e.x, a.x)
            ? 0
            : JSM.IsGreater(e.x, a.x) && (f || d)
              ? ((a = JSM.IsGreater(c.y, b.y)), (f && a) || (d && !a) ? 1 : 0)
              : 1;
    }
    ...
    return 0 !== d % 2
        ? JSM.CoordPolygonPosition2D.Inside
        : JSM.CoordPolygonPosition2D.Outside;
};
JSM.Polygon2D.prototype.SectorPosition = function(a, b, c) {
    ...
    for (f = 0; f < e; f++)
        if (
            ...
            g == JSM.SectorSectorPosition2D.SectorsIntersectEndPoint &&
                (d = JSM.SectorPolygonPosition2D.IntersectionOnVertex);
        }
    return d;
};
JSM.Polygon2D.prototype.IsDiagonal = function(a, b) {
    return a == b ||
    (this.GetPrevVertex(a) == b || this.GetNextVertex(a) == b) ||
    this.vertices[a].IsEqual(this.vertices[b]) ||
    (function(a, b, e) {
        var f = a.GetVertex(b),
            g = a.GetVertex(e),
            f = new JSM.Sector2D(f, g);
        return a.SectorPosition(f, b, e) !=
        JSM.SectorPolygonPosition2D.NoIntersection
            ? !0
            : !1;
    })(this, a, b) ||
    !(function(a, b, e) {
...
JSM.Polygon2D.prototype.ToArray = function() {
    ...
    for (b = 0; b < this.vertices.length; b++)
        (c = this.vertices[b]), a.push(c.Clone());
    return a;
};
...
JSM.Polygon2D.prototype.Clone = function() {
    var a = new JSM.Polygon2D(),
        ...
        c;
    for (b = 0; b < this.vertices.length; b++)
        (c = this.vertices[b]), a.AddVertexCoord(c.Clone());
    return a;
};
...
JSM.ContourPolygon2D.prototype.GetOrientation = function() {
    ...
    for (b = 1; b < this.contours.length; b++)
        if (
            ((c = this.contours[b].GetOrientation()),
...
JSM.ContourPolygon2D.prototype.GetComplexity = function() {
    ...
    for (a = 1; a < this.contours.length; a++)
        if (
            ((b = this.contours[a].GetComplexity()),
...
JSM.ContourPolygon2D.prototype.ToArray = function() {
    ...
    for (b = 0; b < this.contours.length; b++) {
        ...
        for (c = 0; c < d.VertexCount(); c++)
            (e = d.GetVertex(c)), a.push(e.Clone());
...
JSM.ContourPolygon2D.prototype.FromArray = function(a) {
    ...
    for (b = 0; b < a.length; b++)
        (c = a[b]), null === c ? this.AddContour() : this.AddVertex(c.x, c.y);
};
...
JSM.ContourPolygon2D.prototype.Clone = function() {
    var a = new JSM.ContourPolygon2D(),
        ...
        c;
    for (b = 0; b < this.contours.length; b++)
        (c = this.contours[b]), a.AddContour(c.Clone());
    return a;
};
...
JSM.Polygon.prototype.ToPolygon2D = function() {
    ...
    for (c = 0; c < this.vertices.length; c++)
        (d = this.vertices[c].ToCoord2D(a)), b.AddVertex(d.x, d.y);
    return b;
};
...
JSM.ContourPolygon.prototype.ToContourPolygon2D = function() {
    ...
    for (c = 0; c < this.contours.length; c++) {
        ...
        for (d = 0; d < e.VertexCount(); d++)
            (f = e.GetVertex(d)), b.AddVertexCoord(f.ToCoord2D(a));
    }
    return b;
};
...
JSM.OffsetPolygonContour = function(a, b) {
    ...
    for (m = 0; m < c; m++)
        (e = a.GetPrevVertex(m)),
            ...
            (g = JSM.CoordSub(h, f)),
            (k = k.AngleTo(g) / 2),
            JSM.CoordOrientation(e, f, h, d) == JSM.Orientation.Clockwise &&
                (k = Math.PI - k),
            (e = b / Math.sin(k)),
            (h = f.Clone()),
            h.Offset(g, e),
...
JSM.CutVertexType = { Left: 1, Right: 2, Cut: 3 };
...
JSM.PolygonCutter.prototype.Cut = function(a, b, c, d) {
    ...
    return null !== e
        ? ((a = a.Clone()),
          e == JSM.CutVertexType.Left
              ? b.push(a)
              : e == JSM.CutVertexType.Right ? c.push(a) : d.push(a),
          !0)
        : !this.CalculateCutPolygonData() ||
          !this.CalculateEntryVertices() ||
          !this.CalculateCuttedPolygons(b, c)
          ? !1
          : !0;
};
...
JSM.PolygonCutter.prototype.CalculateOriginalPolygonData = function(a) {
    ...
    for (d = 0; d < this.originalPolygon.VertexCount(); d++)
        (e = a.GetVertex(d)),
            ...
            e == JSM.CutVertexType.Left
                ? (b = !0)
                : e == JSM.CutVertexType.Right && (c = !0),
            this.originalPolygonVertexTypes.push(e);
    return b && c
        ? null
        : b
          ? JSM.CutVertexType.Left
          : c ? JSM.CutVertexType.Right : JSM.CutVertexType.Cut;
};
JSM.PolygonCutter.prototype.CalculateCutPolygonData = function() {
    function a(a, b) {
        if (0 === a.length) return !1;
        var c = a[a.length - 1];
        return c == JSM.CutVertexType.Cut || b == JSM.CutVertexType.Cut
            ? !1
            : c != b;
    }
    function b(a, b, c) {
        ...
        c == JSM.CutVertexType.Cut &&
            a.cutVertexIndices.push(a.cutPolygonVertexTypes.length - 1);
    }
    function c(a, c) {
    ...
    for (f = 0; f <= e; f++)
        (g = f === e),
            ...
            g || d(this, h, k);
    this.cutPolygonVertexDistances = this.geometryInterface.getVertexDistances(
        this.cutPolygon
    );
    return !(function(a, b, c) {
        ...
        return !0;
    })(this.cutPolygon, this.cutVertexIndices, this.cutPolygonVertexDistances)
        ? !1
        : !0;
};
JSM.PolygonCutter.prototype.CalculateEntryVertices = function() {
    function a(a, b, c) {
        ...
        if (l == JSM.CutVertexType.Right) {
            if (
                a == JSM.CutVertexType.Left ||
                (a == JSM.CutVertexType.Cut && JSM.IsLowerOrEqual(c, b))
            )
                return 1;
        } else if (l == JSM.CutVertexType.Left) {
            if (
                a == JSM.CutVertexType.Right ||
                (a == JSM.CutVertexType.Cut && JSM.IsGreaterOrEqual(c, b))
            )
                return -1;
    ...
    for (b = 0; b < this.cutVertexIndices.length; b++)
        (c = this.cutVertexIndices[b]),
            ...
            0 !== d &&
                (this.entryVertices.push(c), this.entryVertexTypes.push(d));
    return 0 === this.entryVertices.length ||
    0 !== this.entryVertices.length % 2
        ? !1
        : !0;
};
JSM.PolygonCutter.prototype.CalculateCuttedPolygons = function(a, b) {
    function c(a, b, c, g) {
        function h(a, b, c) {
            return -1 != c[a]
                ? ((b = c[a]), (c[c[a]] = -1), (c[a] = -1), b)
                : JSM.NextIndex(a, b.VertexCount());
        }
        function k(a, b, c, d, e) {
            c = a.entryVertices[c];
            if (-1 !== b[c]) {
                ...
                for (var g = h(c, a.cutPolygon, b), k = null; g != c; ) {
                    null === k &&
                        a.cutPolygonVertexTypes[g] !== JSM.CutVertexType.Cut &&
                        (k = a.cutPolygonVertexTypes[g]);
                    var l = f,
                        m = a.cutPolygon.GetVertex(g).Clone(),
                        B = l.VertexCount();
                    (0 < B && l.GetVertex(B - 1).IsEqual(m)) ||
                        l.AddVertexCoord(m);
                    g = h(g, a.cutPolygon, b);
                }
                2 < f.VertexCount() &&
                    (k == JSM.CutVertexType.Left
                        ? d.push(f)
                        : k == JSM.CutVertexType.Right && e.push(f));
            }
        }
        ...
        if (null === l) return !1;
        for (
            var m = g ? a.entryVertices.length - 1 : 0;
            0 <= m && m < a.entryVertices.length;

        )
            k(a, l, m, b, c), (m = g ? m - 1 : m + 1);
        return !0;
    }
...
JSM.CutPolygon2DWithLine = function(a, b, c, d, e) {
    return new JSM.PolygonCutter({
        ...
        getVertexSide: function(a) {
            ...
            a == JSM.CoordLinePosition2D.CoordAtLineLeft
                ? (c = JSM.CutVertexType.Left)
                : a == JSM.CoordLinePosition2D.CoordAtLineRight &&
                  (c = JSM.CutVertexType.Right);
            return c;
        },
        getIntersectionVertex: function(a, c) {
            var d = new JSM.Line2D(c, JSM.CoordSub2D(c, a)),
                e = new JSM.Coord2D(0, 0);
            return b.LinePosition(d, e) !=
            JSM.LineLinePosition2D.LinesIntersectsOnePoint
                ? null
                : e;
        },
        getVertexDistances: function(a) {
            for (
                var c = new JSM.Coord2D(0, 0),
                    d = b.start.Clone(),
                    c = b.direction.Clone().Rotate(-Math.PI / 2, c),
                    d = new JSM.Line2D(d, c),
                    e,
                    l = [],
                    c = 0;
                c < a.VertexCount();
                ...
                (e = a.GetVertex(c)), l.push(d.CoordSignedDistance(e));
            return l;
        }
    }).Cut(a, c, d, e);
};
JSM.CutPolygonWithPlane = function(a, b, c, d, e) {
    return new JSM.PolygonCutter({
        ...
        getVertexSide: function(a) {
            a = b.CoordPosition(a);
            var c = JSM.CutVertexType.Cut;
            a == JSM.CoordPlanePosition.CoordInFrontOfPlane
                ? (c = JSM.CutVertexType.Left)
                : a == JSM.CoordPlanePosition.CoordAtBackOfPlane &&
                  (c = JSM.CutVertexType.Right);
            return c;
        },
        getIntersectionVertex: function(a, c) {
            var d = new JSM.Line(c, JSM.CoordSub(c, a)),
                e = new JSM.Coord(0, 0, 0);
            return b.LinePosition(d, e) !=
            JSM.LinePlanePosition.LineIntersectsPlane
                ? null
                : e;
        },
        getVertexDistances: function(a) {
            for (
                var c = a.GetNormal(),
                    d = new JSM.Vector(b.a, b.b, b.c),
                    c = JSM.VectorCross(d, c),
                    d = a.GetVertex(0),
                    c = JSM.GetPlaneFromCoordAndDirection(d, c),
                    e,
                    l = [],
                    d = 0;
                d < a.VertexCount();
                ...
                (e = a.GetVertex(d)), l.push(c.CoordSignedDistance(e));
            return l;
        }
    }).Cut(a, c, d, e);
};
        ...
        for (h = 1; h < c; h++) {
            ...
            for (k = 0; k < a.length; k++) {
                var B = b,
                    ...
                    y = [],
                    z = [];
                if (JSM.CutPolygon2DWithLine(a[k], l, y, z, [])) {
                    for (var E = void 0, E = 0; E < y.length; E++) B.push(y[E]);
                    for (E = 0; E < z.length; E++) x.push(z[E]);
                }
            }
            a = A;
        }
...
JSM.ConvertContourPolygonToPolygon2D = function(a, b) {
    ...
    function d(a, b, d, e, f) {
        f = (function(a, b, c, d) {
            function e(a, b, c, d, f) {
                function g(a, b, c) {
                    ...
                    return a ==
                        JSM.SectorPolygonPosition2D.IntersectionOnePoint ||
                    a == JSM.SectorPolygonPosition2D.IntersectionCoincident
                        ? !0
                        : !1;
                }
                if (g(b, c, d)) return !1;
                ...
                for (b = 1; b < a.ContourCount(); b++)
                    if (
                        void 0 === f.addedHoles[b] &&
                        ((h = a.GetContour(b)), g(h, c, d))
                    )
                        return !1;
                return !0;
            }
        ...
        (function(a, b, d, e, f) {
            ...
            void 0 !== f &&
                null !== f &&
                ((k = f[h][0]), (l = f[h][1]), JSM.ShiftArray(f, h + 1));
            e = e.end;
            h = g.GetPrevVertex(e);
    ...
    for (h = 0; h < f.VertexCount(); h++)
        (k = f.GetVertex(h)), c(g, k.Clone(), b, 0, h);
    if (1 == e) return g;
    f = [];
    for (h = 1; h < e; h++) f.push(h);
    for (
        e = { addedHoles: {}, holeTryouts: {}, entryPositions: [] };
        0 < f.length;

    )
        if (((h = f.shift()), d(a, g, h, b, e))) e.addedHoles[h] = !0;
        else {
...
JSM.TriangulateConcavePolygon2D = function(a) {
    function b(a) {
        ...
        for (c = 0; c < b; c++)
            for (d = 0; d < b; d++)
                if (c != d && a.IsDiagonal(c, d)) return { beg: c, end: d };
        return null;
    }
    function c(a, b) {
        function c(a, b, d) {
        ...
        var d = { polygon: new JSM.Polygon2D(), map: [] },
            e = { polygon: new JSM.Polygon2D(), map: [] },
            f,
            p;
        f = b.beg;
        p = a.polygon.GetPrevVertex(b.end);
        c(a, d, b.end);
        a.polygon.EnumerateVertices(f, p, function(b) {
            c(a, d, b);
        });
        f = b.end;
        p = a.polygon.GetPrevVertex(b.beg);
        c(a, e, b.beg);
        a.polygon.EnumerateVertices(f, p, function(b) {
            c(a, e, b);
        });
        return { resultData1: d, resultData2: e };
    }
    var d = [],
        e = (function(a) {
            var b = [],
...
JSM.TriangulatePolygon2D = function(a) {
    ...
    if (3 == b) return [[0, 1, 2]];
    b = a.GetComplexity();
    return b === JSM.Complexity.Invalid
        ? null
        : b == JSM.Complexity.Convex
          ? JSM.TriangulateConvexPolygon(a)
          : JSM.TriangulateConcavePolygon2D(a);
};
...
JSM.CreateOctreeChildNodes = function(a, b) {
    ...
    var d = a.GetSize();
    return JSM.IsZero(d.x) && JSM.IsZero(d.y) && JSM.IsZero(d.z)
        ? null
        : [
              c(a, b, 0, 0, 0),
              c(a, b, 1, 0, 0),
...
JSM.Octree = function(a, b) {
    ...
    if (
        void 0 === this.maxCoordNumInNodes ||
        null === this.maxCoordNumInNodes ||
        0 === this.maxCoordNumInNodes
    )
...
JSM.Octree.prototype.FindNodeForCoord = function(a, b) {
    ...
    var c = b.box.GetCenter(),
        ...
        c = a.z > c.z;
    return !d && !e && !c
        ? this.FindNodeForCoord(a, b.children[0])
        : d && !e && !c
          ? this.FindNodeForCoord(a, b.children[1])
          : d && e && !c
            ? this.FindNodeForCoord(a, b.children[2])
            : !d && e && !c
              ? this.FindNodeForCoord(a, b.children[3])
              : !d && !e && c
                ? this.FindNodeForCoord(a, b.children[4])
                : d && !e && c
                  ? this.FindNodeForCoord(a, b.children[5])
                  : d && e && c
                    ? this.FindNodeForCoord(a, b.children[6])
                    : !d && e && c
                      ? this.FindNodeForCoord(a, b.children[7])
                      : null;
};
JSM.Octree.prototype.SplitNode = function(a) {
    ...
    var d, e;
    for (d = 0; d < c.length; d++)
        (e = this.FindNodeForCoord(this.coords[c[d]], a)), e.coords.push(c[d]);
    return !0;
};
JSM.Octree.prototype.CreateNewNode = function(a, b) {
    return { parent: a, box: b, coords: [], children: null };
};
...
JSM.TriangleOctree.prototype.AddTriangleToNode = function(a, b, c, d, e) {
    if (
        !d.box.IsCoordInside(a) ||
        !d.box.IsCoordInside(b) ||
        !d.box.IsCoordInside(c)
    )
        return !1;
    if (null === d.children) {
        var f = this;
    ...
    if (null !== d.children) {
        ...
        for (g = 0; g < d.children.length; g++)
            if (((h = d.children[g]), this.AddTriangleToNode(a, b, c, h, e)))
                return !0;
    }
    d.triangles.push({ v0: a, v1: b, v2: c, userData: e });
    return !0;
};
JSM.TriangleOctree.prototype.CreateNewNode = function(a, b) {
    return { parent: a, box: b, triangles: [], children: null };
};
...
JSM.BSPTree.prototype.TraverseNode = function(a, b) {
    null !== a &&
        (b(a), this.TraverseNode(a.inside, b), this.TraverseNode(a.outside, b));
};
...
JSM.BSPTree.prototype.AddPolygonToNode = function(a, b, c) {
    ...
    if (null === a.polygon) {
        ...
        var f = [],
            e = [];
        JSM.CutPolygonWithPlane(b, a.plane, f, d, e) &&
            (0 < d.length && this.AddInsidePolygonsToNode(a, d, c),
            0 < f.length && this.AddOutsidePolygonsToNode(a, f, c),
            0 < e.length &&
                ((d = b.GetNormal()),
                0 < JSM.VectorDot(d, a.plane.GetNormal())
                    ? this.AddInsidePolygonsToNode(a, e, c)
    ...
    function g(a, b, c) {
        if (null !== b) {
            var d = [],
                e = [],
                f = [];
            JSM.CutPolygonWithPlane(a, b.plane, e, d, f) &&
                (0 < d.length && k(b, d, c),
                0 < e.length && l(b, e, c),
                0 < f.length &&
                    ((a = a.GetNormal()),
                    0 < JSM.VectorDot(a, b.plane.GetNormal())
                        ? k(b, f, !0)
                        : l(b, f, !0)));
        }
    }
...
JSM.TraverseBSPTreeForEyePosition = function(a, b, c) {
    function d(a) {
        if (null !== a) {
            ...
            f == JSM.CoordPlanePosition.CoordInFrontOfPlane
                ? (d(a.inside), c(a), d(a.outside))
                : (f == JSM.CoordPlanePosition.CoordAtBackOfPlane
                      ? (d(a.outside), c(a))
                      : d(a.outside),
                  d(a.inside));
        }
...
JSM.GenerateCubicBezierCurve = function(a, b, c, d, e) {
    ...
    for (h = 0; h <= e; h++) {
        ...
        var l = k * k,
            ...
            q = p * n;
        k = new JSM.Coord2D(
            q * a.x + 3 * p * k * b.x + 3 * n * l * c.x + m * d.x,
            q * a.y + 3 * p * k * b.y + 3 * n * l * c.y + m * d.y
        );
        f.push(k);
    }
    return f;
...
JSM.GetRuledMesh = function(a, b, c, d, e) {
    if (a.length === b.length) {
        var f = a.length - 1,
            ...
            k;
        for (k = 0; k <= f; k++)
            g.push(JSM.CoordSub(b[k], a[k])), h.push(a[k].DistanceTo(b[k]));
        var l, m;
        for (k = 0; k <= f; k++) {
            l = h[k] / c;
            for (b = 0; b <= c; b++)
                (m = a[k].Clone().Offset(g[k], l * b)), d.push(m);
        }
        for (k = 0; k < f; k++)
            for (b = 0; b < c; b++)
                (a = k * (c + 1) + b),
...
JSM.Ray.prototype.IsLengthReached = function(a) {
    return void 0 === this.length || null === this.length
        ? !1
        : JSM.IsGreater(a, this.length);
};
...
JSM.Path2D.prototype.CubicBezierTo = function(a, b, c, d, e, f) {
    a = JSM.GenerateCubicBezierCurve(
...
JSM.Path2D.prototype.Close = function() {
    function a(a) {
        ...
        a.GetVertex(0).IsEqual(a.GetVertex(a.VertexCount() - 1)) &&
            a.RemoveVertex(a.VertexCount() - 1);
...
JSM.Path2D.prototype.AddPolygonPoint = function(a, b) {
    this.GetCurrentPolygon().AddVertex(
        this.settings.offset.x + a * this.settings.scale.x,
        this.settings.offset.y + b * this.settings.scale.y
    );
    this.position.Set(a, b);
...
JSM.MaterialSet.prototype.GetMaterial = function(a) {
    return 0 > a || a >= this.materials.length
...
JSM.TextureProjectionType = { Planar: 0, Cubic: 1, Cylindrical: 2 };
...
JSM.BodyTextureProjection.prototype.SetCylindrical = function(a, b, c, d) {
    ...
    this.coords = new JSM.CoordSystem(
        a,
        c.Clone().SetLength(b),
        JSM.VectorCross(d, c).SetLength(b),
        d
    );
};
    ...
    for (e = 0; e < this.points.length; e++)
        (f = this.points[e]),
            f.GetVertexIndex() == a
                ? b.push(e)
                : f.GetVertexIndex() >= a &&
                  f.SetVertexIndex(f.GetVertexIndex() - 1);
    for (e = 0; e < this.lines.length; e++)
        (f = this.lines[e]),
            f.GetBegVertexIndex() == a || f.GetEndVertexIndex() == a
                ? c.push(e)
                : (f.GetBegVertexIndex() >= a &&
                      f.SetBegVertexIndex(f.GetBegVertexIndex() - 1),
                  f.GetEndVertexIndex() >= a &&
                      f.SetEndVertexIndex(f.GetEndVertexIndex() - 1));
...
JSM.AdjacencyInfo.prototype.Calculate = function(a) {
    ...
    function c(a, b, c) {
        function d(a, b, c, e, f) {
            ...
            for (h = 0; h < a.edges.length; h++)
                (k = a.edges[h]),
                    k.vert1 === c && k.vert2 === e
                        ? ((g.index = h), (g.reverse = !1))
                        : k.vert1 === e &&
                          k.vert2 === c &&
                          ((g.index = h), (g.reverse = !0));
            -1 === g.index
                ? ((h = new JSM.EdgeInfo()),
                  (h.vert1 = c),
                  (h.vert2 = e),
        ...
        var k = new JSM.PgonInfo(),
            ...
            m,
            n,
            p = b.VertexIndexCount();
        for (l = 0; l < p; l++)
            (m = b.GetVertexIndex(l)),
                (n = b.GetVertexIndex(l < p - 1 ? l + 1 : 0)),
                d(a, k, m, n, c);
        a.pgons.push(k);
    }
    this.verts = [];
    ...
    for (d = 0; d < a.PolygonCount(); d++) c(this, a, d);
};
...
JSM.AdjacencyInfo.prototype.GetAnotherPgonOfEdge = function(a, b) {
    return -1 != a.pgon1 && a.pgon1 != b
        ? a.pgon1
        : -1 != a.pgon2 && a.pgon2 != b ? a.pgon2 : -1;
};
...
JSM.CheckBody = function(a) {
    ...
    for (c = 0; c < a.LineCount(); c++)
        if (
            ((d = a.GetLine(c)),
            0 > d.GetBegVertexIndex() ||
                d.GetBegVertexIndex() >= b ||
                0 > d.GetEndVertexIndex() ||
                d.GetEndVertexIndex() >= b)
        )
            return !1;
    for (c = 0; c < a.PolygonCount(); c++) {
        e = a.GetPolygon(c);
        ...
        if (((h = a.GetPolygon(e)), (b[e] = []), h.HasCurveGroup())) {
            ...
            for (f = 0; f < h.VertexIndexCount(); f++) {
                ...
                for (g = 0; g < m.length; g++)
                    (n = a.GetPolygon(m[g])),
                        n.GetCurveGroup() === h.GetCurveGroup() &&
                            ((k = JSM.CoordAdd(k, c[m[g]])), l++);
...
JSM.CalculatePolygonCurveGroups = function(a, b) {
    ...
    f = c[0];
    d = c[d - 1];
    if (0 === f && f != d) for (e = 0; c[e] == f; e++) c[e] = d;
    return c;
};
...
JSM.MakeBodyInsideOut = function(a) {
    ...
    for (b = 0; b < a.PolygonCount(); b++)
        (c = a.GetPolygon(b)), c.ReverseVertexIndices();
};
JSM.SoftMoveBodyVertex = function(a, b, c, d, e) {
    ...
    for (g = 0; g < a.VertexCount(); g++)
        (h = b.DistanceTo(a.GetVertex(g).position)),
            JSM.IsGreater(h, c) ||
                ((h = JSM.GetGaussianValue(h, e, 0, f)),
...
JSM.GenerateWireBody = function(a) {
    ...
    for (c = 0; c < a.edges.length; c++)
        (d = a.edges[c]), JSM.AddLineToBody(b, d.vert1, d.vert2);
    return b;
};
            ...
            for (d = 0; d < f.length; d++)
                (g = f[d]),
                    (g = new JSM.BodyPolygon([
                        e.GetVertexIndex(g[0]),
                        e.GetVertexIndex(g[1]),
                        e.GetVertexIndex(g[2])
                    ])),
...
JSM.GenerateRandomMaterials = function(a, b, c) {
    function d(a, b) {
        ...
        return (c =
            void 0 !== a && a
                ? JSM.SeededRandomInt(0, 16777215, b + 1)
                : JSM.RandomInt(0, 16777215));
    }
    var e,
        f,
        g = 0;
    for (e = 0; e < a.LineCount(); e++)
        (f = d(c, g++)),
            (f = b.AddMaterial(new JSM.Material({ ambient: f, diffuse: f }))),
...
JSM.AddBodyToBSPTree = function(a, b, c) {
    ...
    for (d = 0; d < a.PolygonCount(); d++) {
        f = { id: c, originalPolygon: d, material: -1 };
        e = a;
        var g = f,
            h = e.GetPolygon(d);
        g.material = h.GetMaterialIndex();
        for (
            var g = new JSM.Polygon(), k = void 0, l = void 0, k = 0;
            k < h.VertexIndexCount();
            k++
        )
...
JSM.CalculateCubicTextureCoord = function(a, b, c) {
    ...
    for (l = 0; 3 > l; l++)
        0 === l ? (m = e) : 1 === l ? (m = f) : 2 === l && (m = g),
            ...
            JSM.IsGreater(n, k) && ((h = l), (k = n));
    if (-1 === h) return d;
    b = null;
    0 === h
        ? (b = new JSM.CoordSystem(c.origo, f, g, new JSM.Coord(0, 0, 0)))
        : 1 === h
          ? (b = new JSM.CoordSystem(c.origo, e, g, new JSM.Coord(0, 0, 0)))
          : 2 === h &&
            (b = new JSM.CoordSystem(c.origo, e, f, new JSM.Coord(0, 0, 0)));
...
JSM.CalculateBodyTextureCoords = function(a) {
    ...
    c === JSM.TextureProjectionType.Planar
        ? (b = JSM.CalculateBodyPlanarTextureCoords(a))
        : c === JSM.TextureProjectionType.Cubic
          ? (b = JSM.CalculateBodyCubicTextureCoords(a))
          : c === JSM.TextureProjectionType.Cylindrical &&
            (b = JSM.CalculateBodyCylindricalTextureCoords(a));
    return b;
};
JSM.CutBodyByPlane = function(a, b) {
    function c(a, b, c) {
        ...
        if (!l) {
            ...
            for (m = 0; m < g; m++)
                (q = a[m]),
                    h.push(new JSM.Coord(q.x, q.y, q.z)),
                    f && c.push(m);
            return h;
        }
        l = [];
        ...
        for (m = 0; m < g; m++)
            (p = m - 1),
                ...
                (q = a[r]),
                k[r]
                    ? (k[p] || e(p, r, l, n), d(r, q, l, n))
                    : k[p] && e(p, r, l, n);
        for (m = 0; m < l.length; m++)
            (g = l[m]),
                (k = h[h.length - 1]),
                0 === m || !k.IsEqual(g)
                    ? (h.push(new JSM.Coord(g.x, g.y, g.z)),
                      f && ((g = n[m]), c.push(g)))
                    : f &&
                      ((g = n[m]),
                      (k = n[m - 1]),
    ...
    function d(a, b, c) {
        ...
        -1 === d &&
            (d = a.AddVertex(new JSM.BodyVertex(new JSM.Coord(b.x, b.y, b.z))));
        return d;
    }
    var e = new JSM.Body(),
        f = [],
    ...
    for (l = 0; l < a.PolygonCount(); l++) {
        ...
        for (m = 0; m < n.VertexIndexCount(); m++)
            (q = a.GetVertexPosition(n.GetVertexIndex(m))),
                p.push(new JSM.Coord(q.x, q.y, q.z));
        q = [];
        p = c(p, b, q);
    ...
    for (l = 0; l < a.VertexCount(); l++)
        h[l] &&
            ((r = a.GetVertexPosition(l)),
            (k[l] = e.AddVertex(
                new JSM.BodyVertex(new JSM.Coord(r.x, r.y, r.z))
            )));
    var h = e.VertexCount(),
        s;
    for (l = 0; l < a.PolygonCount(); l++)
        if (((n = a.GetPolygon(l)), (p = f[l]), (q = g[l]), 0 !== q.length)) {
            ...
            for (m = 0; m < q.length; m++)
                -1 !== q[m]
                    ? s.push(k[n.GetVertexIndex(q[m])])
                    : ((r = p[m]), s.push(d(e, r, h)));
...
JSM.GenerateSegmentedCuboid = function(a, b, c, d) {
    ...
    function g(a) {
        ...
        if (0 === a || a === d)
            for (a = 0; a <= d; a++)
                for (b = 0; b <= d; b++)
                    (c = new JSM.Coord(b * p - l, a * q - m, e - n)),
            ...
            for (b = 0; b < d; b++)
                for (c = 0; c < d; c++)
                    (f = m + b * (d + 1) + c),
                        ...
                        (l = h + 1),
                        0 === a
                            ? k.AddPolygon(new JSM.BodyPolygon([f, h, l, g]))
...
JSM.GenerateCircle = function(a, b) {
    ...
    c.AddPolygon(d);
    c.SetCylindricalTextureProjection(
        new JSM.Coord(0, 0, 0),
        a,
        new JSM.Coord(1, 0, 0),
        new JSM.Coord(0, 0, 1)
...
JSM.GenerateTriangulatedSphere = function(a, b, c) {
    ...
    for (
        var e = d.GetVertexPosition(0).Length(), f = a / e, g, h, e = 0;
        e < d.VertexCount();
        e++
    )
        (h = d.GetVertex(e)), h.position.MultiplyScalar(f);
    for (var k, l, m, n, f = 0; f < b; f++) {
        ...
        for (e = 0; e < h.edges.length; e++)
            (l = h.edges[e]),
                (l = JSM.MidCoord(
                    g.GetVertexPosition(l.vert1),
                    g.GetVertexPosition(l.vert2)
                )),
...
JSM.GenerateCylinder = function(a, b, c, d, e) {
    ...
    for (k = 0; k < c; k++)
        f.AddVertex(
            new JSM.BodyVertex(JSM.CylindricalToCartesian(a, b / 2, g))
        ),
            f.AddVertex(
                new JSM.BodyVertex(JSM.CylindricalToCartesian(a, -b / 2, g))
            ),
    ...
    f.SetCylindricalTextureProjection(
        new JSM.Coord(0, 0, -(b / 2)),
        a,
        new JSM.Coord(1, 0, 0),
        new JSM.Coord(0, 0, 1)
    );
...
JSM.GeneratePie = function(a, b, c, d, e, f) {
    ...
    for (c = 0; c < d; c++)
        g.AddVertex(
            new JSM.BodyVertex(JSM.CylindricalToCartesian(a, b / 2, h))
        ),
            g.AddVertex(
                new JSM.BodyVertex(JSM.CylindricalToCartesian(a, -b / 2, h))
            ),
    ...
    g.SetCylindricalTextureProjection(
        new JSM.Coord(0, 0, -(b / 2)),
        a,
        new JSM.Coord(1, 0, 0),
        new JSM.Coord(0, 0, 1)
...
JSM.GenerateCone = function(a, b, c, d, e, f) {
    ...
    h &&
        g.AddVertex(
            new JSM.BodyVertex(JSM.CylindricalToCartesian(0, c / 2, 0))
        );
    var n;
    for (n = 0; n < d; n++)
        h ||
            g.AddVertex(
                new JSM.BodyVertex(JSM.CylindricalToCartesian(a, c / 2, l))
            ),
            k ||
                g.AddVertex(
                    new JSM.BodyVertex(JSM.CylindricalToCartesian(b, -c / 2, l))
                ),
            (l -= m);
    k &&
        g.AddVertex(
    ...
    for (n = 0; n < d; n++)
        h
            ? ((l = n + 1),
              (m = l + 1),
              n === d - 1 && (m = 1),
              (l = new JSM.BodyPolygon([0, m, l])))
            : k
              ? ((l = n),
                (m = l + 1),
                n === d - 1 && (m = 0),
                (l = new JSM.BodyPolygon([l, m, d])))
              : ((l = 2 * n),
                (m = l + 2),
                n === d - 1 && (m = 0),
...
JSM.GeneratePrismGeometry = function(a, b, c) {
    ...
    if (c) {
        ...
        for (f = 0; f < e; f++)
            c.AddVertexIndex(2 * f + 1), a.AddVertexIndex(2 * (e - f - 1));
        d.AddPolygon(c);
        d.AddPolygon(a);
    }
    return d;
...
JSM.GeneratePrismWithHole = function(a, b, c, d, e) {
    ...
    (function(a, b, c, d) {
        ...
        for (f = 0; f < a.ContourCount(); f++) {
            ...
            void 0 !== c &&
                null !== c &&
                (w = JSM.CalculatePolygonCurveGroups(g, c));
            h = g.VertexCount();
            b.push(e);
            for (g = 0; g < h; g++)
                (k = 2 * e + 2 * g),
...
JSM.GeneratePrismsFromPath2D = function(a, b, c, d) {
    function e(a) {
        ...
        for (c = 0; c < a.ContourCount(); c++) {
            e = a.GetContour(c);
            for (d = 0; d < e.VertexCount(); d++)
                (f = e.GetVertex(d)), b.push(new JSM.Coord(f.x, f.y, 0));
    ...
    for (h = 0; h < a.length; h++)
        (k = a[h]),
            1 === k.ContourCount()
                ? f.push(JSM.GeneratePrism(e(k), g, b, c, d))
                : 1 < k.ContourCount() &&
                  f.push(JSM.GeneratePrismWithHole(e(k), g, b, c, d));
    return f;
};
JSM.GeneratePrismShell = function(a, b, c, d, e) {
    ...
    var k;
    for (h = 0; h < g; h++)
        (k = a[h].Clone().Offset(b, c)), f.AddVertex(new JSM.BodyVertex(k));
    for (h = 0; h < g; h++)
        (k = d[h].Clone().Offset(b, c)), f.AddVertex(new JSM.BodyVertex(k));
    var l;
    for (h = 0; h < g; h++)
        (c = h),
            (d = c + 1),
...
JSM.GenerateLineShell = function(a, b, c, d, e, f) {
    ...
    for (l = 0; l < h; l++)
        0 === l || l === h - 1
            ...
            : ((m = l - 1),
              (n = l),
              (p = l + 1),
              (r = JSM.CoordSub(a[p], a[n])),
              (q = JSM.CoordSub(a[m], a[n])),
              (q = r.AngleTo(q) / 2),
              JSM.CoordOrientation(a[m], a[n], a[p], b) ==
                  JSM.Orientation.Clockwise && (q = Math.PI - q)),
            k.push(q);
    ...
    for (l = 0; l < h; l++)
        (n = l),
            l === h - 1
                ? (v = JSM.CoordSub(a[n - 1], a[n]))
                : ((p = (l + 1) % h), (v = JSM.CoordSub(a[n], a[p]))),
            (q = k[n]),
            (p = d / Math.sin(q)),
            (s = a[n].Clone()),
            s.Offset(v, p),
            s.Rotate(r, -(Math.PI - q), a[n]),
            m.push(s);
    for (l = 0; l < h; l++) g.AddVertex(new JSM.BodyVertex(a[l]));
    for (l = 0; l < h; l++) g.AddVertex(new JSM.BodyVertex(m[l]));
    for (l = 0; l < h; l++)
        (n = a[l].Clone().Offset(b, c)), g.AddVertex(new JSM.BodyVertex(n));
    for (l = 0; l < h; l++)
        (n = m[l].Clone().Offset(b, c)), g.AddVertex(new JSM.BodyVertex(n));
    for (l = 0; l < h - 1; l++)
        (n = l),
            (p = n + 1),
            (c = n + 2 * h),
            (d = c + 1),
            g.AddPolygon(new JSM.BodyPolygon([n, p, d, c])),
            g.AddPolygon(new JSM.BodyPolygon([n + h, c + h, d + h, p + h]));
    e &&
        ((n = 0),
    ...
    if (f)
        for (l = 0; l < h - 1; l++)
            (n = l),
                ...
                (c = l + h),
                (d = c + 1),
                g.AddPolygon(new JSM.BodyPolygon([n, c, d, p])),
                g.AddPolygon(
                    new JSM.BodyPolygon([
                        n + 2 * h,
                        p + 2 * h,
    ...
    for (l = 0; l < c; l++) {
        ...
        for (a = 0; a < d; a++)
            (h = l * d + a),
                ...
                (g = b + 1),
                a === d - 1 && ((k = l * d), (g = (l + 1) * d)),
                l === c - 1 && ((b = a), (g = a + 1), a === d - 1 && (g = 0)),
                (h = new JSM.BodyPolygon([h, b, g, k])),
                e && h.SetCurveGroup(0),
                f.AddPolygon(h);
    }
    f.SetCubicTextureProjection(
        new JSM.Coord(0, 0, 0),
        new JSM.Coord(1, 0, 0),
        new JSM.Coord(0, 1, 0),
        new JSM.Coord(0, 0, 1)
...
JSM.GenerateRevolved = function(a, b, c, d, e, f) {
    ...
    for (m = 0; m < k; m++)
        for (n = 0; n <= d; n++)
            (h && n === d) ||
                ((p = a[m].Clone().Rotate(c, n * l, b.beg)),
                g.AddVertex(new JSM.BodyVertex(p)));
    l = 0;
    ...
    for (m = e = 0; m < k; m++)
        (n = h.ProjectCoord(a[m])), (e += n.DistanceTo(a[m]));
    e /= k;
...
JSM.GenerateFunctionSurface = function(a, b, c, d, e) {
    var f = new JSM.Sector(
        new JSM.Coord(b.x, b.y, 0),
        new JSM.Coord(c.x, b.y, 0)
    );
...
JSM.ExplodeBody = function(a, b, c) {
    function d(a, b, c, d) {
        ...
        var l;
        for (k = 0; k < a; k++)
            (l = d.getMaterial(k)), -1 !== l ? b[l].push(k) : c.push(k);
    }
    ...
    (function(a, b, c) {
        function h(c, d, g) {
            if (0 !== c.length) {
                d = b.GetMaterial(d);
                if (
                    void 0 !== g.onPointGeometryStart &&
                    null !== g.onPointGeometryStart
                )
                ...
                if (
                    void 0 !== g.onPointGeometryEnd &&
                    null !== g.onPointGeometryEnd
                )
    ...
    (function(a, b, c) {
        function h(c, d, g) {
            if (0 !== c.length) {
                d = b.GetMaterial(d);
                if (
                    void 0 !== g.onLineGeometryStart &&
                    null !== g.onLineGeometryStart
                )
                ...
                if (
                    void 0 !== g.onLineGeometryEnd &&
                    null !== g.onLineGeometryEnd
                )
    ...
    (function(a, b, c) {
        function h(a, b) {
            ...
            return { vertexNormals: c, textureCoords: f };
        }
        function k(c, d, g, h) {
            if (0 !== c.length) {
                d = b.GetMaterial(d);
                ...
                for (k = 0; k < c.length; k++) {
                    var l = c[k],
                        ...
                        n = h,
                        p = a.GetPolygon(l),
                        x = p.VertexIndexCount();
                    if (3 > x) JSM.Message("Invalid polygon found.");
                    else {
                        var y = void 0,
                            z = void 0,
                            E = void 0,
                            ...
                            L = void 0,
                            y = !1;
                        void 0 !== n.hasConvexPolygons &&
                            null !== n.hasConvexPolygons &&
                            (y = n.hasConvexPolygons);
                        var F = void 0;
                        if (3 == x || y)
                            for (F = 0; F < x - 2; F++) {
                                if (
                                    ((y = a.GetVertexPosition(
                                        p.GetVertexIndex(0)
                                    )),
                                    (z = a.GetVertexPosition(
                                        p.GetVertexIndex((F + 1) % x)
                                    )),
                                    (E = a.GetVertexPosition(
                                        p.GetVertexIndex((F + 2) % x)
                                    )),
                                    (H = m.vertexNormals[l][0]),
                                    (I = m.vertexNormals[l][(F + 1) % x]),
                                    (D = m.vertexNormals[l][(F + 2) % x]),
                                    (L = K = C = null),
                                    null !== m.textureCoords &&
                                        ((C = m.textureCoords[l][0]),
                                        (K = m.textureCoords[l][(F + 1) % x]),
                                        (L = m.textureCoords[l][(F + 2) % x])),
                                    void 0 !== n.onTriangle &&
                                        null !== n.onTriangle)
                                )
                                    n.onTriangle(y, z, E, H, I, D, C, K, L);
                            }
                        else {
                            y = new JSM.Polygon();
                            z = void 0;
                            for (F = 0; F < x; F++)
                                (z = a.GetVertexPosition(p.vertices[F])),
                                    y.AddVertex(z.x, z.y, z.z);
                            F = JSM.CalculateBodyPolygonNormal(a, l);
                            x = JSM.TriangulatePolygon(y, F);
                            if (null !== x)
                                for (var J = void 0, F = 0; F < x.length; F++) {
                                    if (
                                        ((J = x[F]),
                                        (y = a.GetVertexPosition(
                                            p.GetVertexIndex(J[0])
                                        )),
                                        (z = a.GetVertexPosition(
                                            p.GetVertexIndex(J[1])
                                        )),
                                        (E = a.GetVertexPosition(
                                            p.GetVertexIndex(J[2])
                                        )),
                                        (H = m.vertexNormals[l][J[0]]),
                                        (I = m.vertexNormals[l][J[1]]),
                                        (D = m.vertexNormals[l][J[2]]),
                                        (L = K = C = null),
                                        null !== m.textureCoords &&
                                            ((C = m.textureCoords[l][J[0]]),
        ...
        if (0 !== a.PolygonCount()) {
            ...
            var n = h(a, b),
                p;
            for (p = 0; p < l.length; p++) k(l[p], p, n, c);
            k(m, -1, n, c);
        }
    })(a, b, c);
    return !0;
    ...
    function f(b) {
        ...
        if (!(3 > f)) {
            ...
            if (3 === f)
                ...
                f = JSM.TriangulatePolygon(g, q);
                if (null !== f)
                    for (b = 0; b < f.length; b++)
                        (p = f[b]),
                            (g = a.GetVertex(d.GetVertexIndex(p[0])).position),
                            (n = a.GetVertex(d.GetVertexIndex(p[1])).position),
                            (p = a.GetVertex(d.GetVertexIndex(p[2])).position),
                            e(q, g, n, p);
            } else
                for (b = 0; b < f - 2; b++)
                    (g = a.GetVertex(d.GetVertexIndex(0)).position),
                        (n = a.GetVertex(d.GetVertexIndex((b + 1) % f))
                            .position),
                        (p = a.GetVertex(d.GetVertexIndex((b + 2) % f))
                            .position),
                        e(q, g, n, p);
        }
    }
...
JSM.ExportBodyGeometryToGdl = function(a, b) {
    ...
    function f(b, c) {
        ...
        -1 != e.pgon1 &&
            -1 != e.pgon2 &&
            a.GetPolygon(e.pgon1).HasCurveGroup() &&
            a.GetPolygon(e.pgon2).HasCurveGroup() &&
            a.GetPolygon(e.pgon1).GetCurveGroup() ==
                a.GetPolygon(e.pgon2).GetCurveGroup() &&
            (f = 2);
        d(
            "edge " +
                (e.vert1 + 1) +
    ...
    function g(e, f, g) {
        var h = -1;
        b &&
            ((h = a.GetPolygon(f).GetMaterialIndex() + 2),
...
JSM.ExportBodyToGdl = function(a, b) {
    ...
    void 0 !== b &&
        null !== b &&
        ((c += JSM.ExportMaterialsToGdl(b)), (d = !0));
...
JSM.TriangleBody.prototype.AddDefaultUV = function() {
    return -1 != this.defaultUVIndex
        ? this.defaultUVIndex
        : (this.defaultUVIndex = this.AddUV(0, 0));
};
...
JSM.TriangleBody.prototype.AddTriangle = function(
    a,
    b,
    c,
    d,
...
JSM.TriangleBody.prototype.GetBoundingSphere = function() {
    var a = this.GetCenter(),
        ...
        d;
    for (c = 0; c < this.vertices.length; c++)
        (d = a.DistanceTo(this.vertices[c])), JSM.IsGreater(d, b) && (b = d);
    return new JSM.Sphere(a, b);
};
...
JSM.ConvertTriangleBodyToOctree = function(a) {
    ...
    for (c = 0; c < a.TriangleCount(); c++)
        (d = a.GetTriangle(c)),
            ...
            (f = a.GetVertex(d.v1)),
            (d = a.GetVertex(d.v2)),
            b.AddTriangle(e, f, d, { triangleIndex: c });
    return b;
};
...
JSM.TriangleModel.prototype.VertexCount = function() {
    ...
    for (b = 0; b < this.bodies.length; b++)
        (c = this.bodies[b]), (a += c.VertexCount());
    return a;
};
JSM.TriangleModel.prototype.TriangleCount = function() {
    var a = 0,
        ...
        c;
    for (b = 0; b < this.bodies.length; b++)
        (c = this.bodies[b]), (a += c.TriangleCount());
    return a;
};
...
JSM.ConvertBodyToTriangleBody = function(a) {
    ...
    for (d = 0; d < a.VertexCount(); d++)
        (f = a.GetVertexPosition(d)), c.AddVertex(f.x, f.y, f.z);
    var g, h, k, l;
    for (d = 0; d < a.PolygonCount(); d++)
...
JSM.ConvertTriangleModelToJsonData = function(a) {
    ...
    var c = { version: 1, materials: [], meshes: [] };
    (function(a, b) {
        var c, d, e;
        for (c = 0; c < a.MaterialCount(); c++)
            (d = a.GetMaterial(c)),
                ...
                void 0 !== d.texture &&
                    null !== d.texture &&
                    ((e.texture = JSM.ValueOrDefault(d.texture, null)),
                    (e.offset = d.offset),
                    (e.scale = d.scale),
    ...
    function b(a, b, c) {
        function d(a, b, c, e, f, g) {
            var h = b.material,
                k = c[h];
            void 0 === k &&
                (a.triangles.push({ material: h, parameters: [] }),
        ...
        for (r = 0; r < b.triangles.length; r++)
            (s = b.triangles[r]), d(a, s, c, e, f, g);
    }
    var c = { version: a.version, materials: a.materials, meshes: [] },
        d = {
            name: "Merged",
            vertices: [],
            normals: [],
...
JSM.RayTriangleIntersection = function(a, b, c, d) {
    ...
    return { position: JSM.CoordAdd(e, a), distance: d };
};
JSM.RayBoxIntersection = function(a, b, c) {
    ...
    for (l = 0; 3 > l; l++)
        JSM.IsLower(f[l], b[l])
            ? ((g[l] = -1), (h[l] = b[l]), (k = !1))
            : JSM.IsGreater(f[l], c[l])
              ? ((g[l] = 1), (h[l] = c[l]), (k = !1))
              : (g[l] = 0);
    l = null;
    if (k) return (l = { position: d, distance: 0 });
    k = [0, 0, 0];
    for (l = 0; 3 > l; l++)
        0 !== g[l] && !JSM.IsZero(e[l])
            ? (k[l] = (h[l] - f[l]) / e[l])
            : (k[l] = -1);
    g = 0;
    ...
    d = d.DistanceTo(f);
    return a.IsLengthReached(d) ? null : (l = { position: f, distance: d });
};
...
JSM.RayTriangleModelIntersectionWithOctree = function(a, b, c) {
    ...
    for (g = 0; g < b.BodyCount(); g++)
        if (
            ...
            20 < h.TriangleCount()
                ? (void 0 === h.octree &&
                      (h.octree = JSM.ConvertTriangleBodyToOctree(h)),
                  (h = JSM.RayOctreeIntersection(a, h.octree, k)))
                : (h = JSM.RayTriangleBodyIntersection(a, h, k)),
            h)
        ) {
            e = !0;
            if (!f) break;
            if (null === d || k.distance < d.distance)
                (d = k),
                    void 0 !== k.userData &&
                        (d.triangleIndex = k.userData.triangleIndex),
                    (d.bodyIndex = g);
        }
    f &&
        null !== d &&
...
JSM.LoadMultipleBuffersInternal = function(a, b, c, d) {
    if (b >= a.length) d(c);
        ...
        var e = a[b],
            ...
            f = e.isFile
                ? e.isArrayBuffer
                  ? JSM.GetArrayBufferFromFile
                  : JSM.GetStringBufferFromFile
                : e.isArrayBuffer
                  ? JSM.GetArrayBufferFromURL
                  : JSM.GetStringBufferFromURL;
    ...
    (function(a, h) {
        function k(a, b, c) {
            ...
            f(a, b, function(b, c) {
                b == h.MAT_COLOR
                    ? e ||
                      ((d[0] = a.ReadUnsignedCharacter() / 255),
        ...
        function m(a, b, c, e) {
            ...
            f(a, b, function(b, c) {
                b == h.MAT_TEXMAP_NAME
                    ? (e.texture = d(a))
                    : b == h.MAT_TEXMAP_UOFFSET
                      ? (e.offset[0] = a.ReadFloat32())
                      : b == h.MAT_TEXMAP_VOFFSET
                        ? (e.offset[1] = a.ReadFloat32())
                        : b == h.MAT_TEXMAP_USCALE
                          ? (e.scale[0] = a.ReadFloat32())
                          : b == h.MAT_TEXMAP_VSCALE
                            ? (e.scale[1] = a.ReadFloat32())
                            : b == h.MAT_TEXMAP_ROTATION
                              ? (e.rotation = a.ReadFloat32())
                              : a.Skip(c - 6);
            });
        }
        function n(a, e, g) {
                        ...
                        : b == h.MAT_SPECULAR
                          ...
                          : b == h.MAT_SHININESS
                            ? (c(
                              ...
                              (n.shininess = l(a, b, f)))
                            : b == h.MAT_SHININESS_STRENGTH
                              ? (c(
                                    "Read material shininess strength chunk (" +
                                        e.toString(16) +
                                        ", " +
                                        g +
                                        ")",
                                ...
                                (n.shininessStrength = l(a, b, f)))
                              : b == h.MAT_TRANSPARENCY
                                ? (c(
                                      "Read material transparency chunk (" +
                                          e.toString(16) +
                                          ", " +
                                          g +
                                          ")",
                                  ...
                                  (n.transparency = l(a, b, f)))
                                : b == h.MAT_TEXMAP
                                  ? (c(
                                        "Read material texture map chunk (" +
                                            e.toString(16) +
                                            ", " +
                                            g +
                                            ")",
            ...
            f(a, e, function(e, f) {
                if (e == h.TRI_MATERIAL) {
                    ...
                    for (m = 0; m < l; m++)
                        if (
                            ((n = a.ReadUnsignedInteger16()),
                            void 0 !== b.onFaceMaterial &&
                                null !== b.onFaceMaterial)
                        )
                            b.onFaceMaterial(n, g);
                } else if (e == h.TRI_SMOOTH) {
                    c(
                        "Read face smoothing groups chunk (" +
                            e.toString(16) +
                            ", " +
                            f +
                            ")",
                    ...
                    for (g = 0; g < k; g++)
                        if (
                            ((l = a.ReadUnsignedInteger32()),
                            void 0 !== b.onFaceSmoothingGroup &&
                ...
                if (d == h.TRI_VERTEX) {
                    ...
                    for (g = 0; g < f; g++)
                        if (
                            ((k = a.ReadFloat32()),
                            (l = a.ReadFloat32()),
                            void 0 !== b.onTextureVertex &&
                                null !== b.onTextureVertex)
                        )
                            b.onTextureVertex(k, l);
                } else if (d == h.TRI_FACE) p(a, d, e);
                else if (d == h.TRI_TRANSFORMATION) {
                    c(
                        "Read transformation chunk (" +
                            d.toString(16) +
                            ", " +
                            e +
                            ")",
        ...
        function s(a, b, d) {
            ...
            f(a, b, function(b, d) {
                b == h.EDIT_MATERIAL
                    ...
                    : b == h.EDIT_OBJECT
                      ? r(a, b, d)
                      : (c("Skip chunk (" + b.toString(16) + ", " + d + ")", 2),
                        a.Skip(d - 6));
            });
        }
        function v(a, g, k) {
            ...
            g = a.GetPosition() + k - 6;
            f(a, g, function(b, f) {
                b == h.OBJECT_HIERARCHY
                    ? ((m.name = d(a)),
                      (m.flags = a.ReadUnsignedInteger32()),
                      (m.userId = a.ReadUnsignedInteger16()))
                    : b == h.OBJECT_PIVOT
                      ? (m.pivot = e(a))
                      : b == h.OBJECT_POSITION
                        ? (m.positions = l(a, h.OBJECT_POSITION))
                        : b == h.OBJECT_ROTATION
                          ? (m.rotations = l(a, h.OBJECT_ROTATION))
                          : b == h.OBJECT_SCALE
                            ? (m.scales = l(a, h.OBJECT_SCALE))
                            : b == h.OBJECT_ID
                              ? (m.nodeId = a.ReadUnsignedInteger16())
                              : (c(
                                    "Skip chunk (" +
                                        b.toString(16) +
                                        ", " +
        ...
        function t(a, b, d) {
            ...
            f(a, b, function(b, d) {
                b == h.EDIT3DS
                    ...
                    : b == h.KF3DS
                      ? u(a, b, d)
                      : (c("Skip chunk (" + b.toString(16) + ", " + d + ")", 1),
                        a.Skip(d - 6));
            });
        }
        var w = a.GetByteLength();
        f(a, w, function(b, d) {
            b == h.MAIN3DS
                ? t(a, b, d)
                : (c("Skip chunk (" + b.toString(16) + ", " + d + ")", 0),
                  a.Skip(d - 6));
        });
...
JSM.Convert3dsToJsonData = function(a, b) {
    function c(a) {
        return void 0 !== b.onFileRequested && null !== b.onFileRequested
            ? b.onFileRequested(a)
            : null;
    }
    if (void 0 === b || null === b) b = {};
            ...
            if (void 0 === f[a.name]) {
                var b = d.AddMaterial({
                        ...
                        shininess:
                            void 0 === a.shininess ||
                            null === a.shininess ||
                            void 0 === a.shininessStrength ||
                            null === a.shininessStrength
                                ? 0
                                : a.shininess * a.shininessStrength,
                        opacity:
                            void 0 === a.transparency || null === a.transparency
                                ? 1
                                : 1 - a.transparency
                    }),
                    e = d.GetMaterial(b);
    ...
    (function(a, b, c) {
        ...
        function e(a, b, c, f) {
            ...
            for (g = 0; g < a.TriangleCount(); g++)
                (h = a.GetTriangle(g)),
                    b && ((h.u0 = h.v0), (h.u1 = h.v1), (h.u2 = h.v2)),
                    (k = f.faceToMaterial[g]),
                    void 0 !== k && ((k = c[k]), void 0 !== k && (h.mat = k)),
...
JSM.ReadObjFile = function(a, b) {
        ...
        if (0 !== a.length && "#" != a[0]) {
            ...
            if (!(0 === q.length || "#" == q[0][0])) {
                ...
                if ("g" == q[0]) {
                    ...
                    3 > q.length ||
                        ((h.uvCount += 1),
                        f(parseFloat(q[1]), parseFloat(q[2])));
                else if ("f" == q[0]) {
                    if (!(4 > q.length)) {
                        var s = [],
                            v = [],
                        ...
                        for (r = 1; r < q.length; r++)
                            (t = q[r].split("/")),
                                ...
                                1 < t.length &&
                                    0 < t[1].length &&
                                    u.push(n(parseInt(t[1], 10), h.uvCount)),
                                2 < t.length &&
                                    0 < t[2].length &&
                                    v.push(
                                        n(parseInt(t[2], 10), h.normalCount)
                                    );
                    ...
                    if (
                        !(2 > q.length) &&
                        void 0 !== b.onNewMaterial &&
                        null !== b.onNewMaterial
                    )
                        b.onNewMaterial(q[1]);
                } else if ("Ka" == q[0] || "Kd" == q[0] || "Ks" == q[0])
                    4 > q.length ||
                        c(
                            q[0],
                            parseFloat(q[1]),
                ...
                else if ("Ns" == q[0] || "Tr" == q[0] || "d" == q[0]) {
                    if (
                        !(2 > q.length) &&
                        void 0 !== b.onMaterialParameter &&
                        null !== b.onMaterialParameter
                    )
                        b.onMaterialParameter(q[0], q[1]);
                } else if ("map_Kd" == q[0]) {
                    if (
                        !(2 > q.length) &&
                        ((q = p(a, "map_Kd")),
                        void 0 !== b.onMaterialTexture &&
                            null !== b.onMaterialTexture)
                    )
                        b.onMaterialTexture(q);
                } else
                    "mtllib" == q[0] &&
                        !(2 > q.length) &&
                        ((q = p(a, "mtllib")),
    ...
    if (void 0 === b || null === b) b = {};
    k(a, { vertexCount: 0, normalCount: 0, uvCount: 0 });
};
    ...
    JSM.ReadObjFile(a, {
        ...
        onMaterialParameter: function(a, b) {
            if (null !== h)
                if ("Ns" == a)
                    (h.shininess = 0),
                        JSM.IsPositive(b) &&
                            (h.shininess = (Math.log2(parseFloat(b)) - 1) / 10);
        ...
        onFace: function(a, b, c) {
            var d,
                ...
                l = a.length;
            for (d = 0; d < l - 2; d++)
                (e = f.AddTriangle(a[0], a[(d + 1) % l], a[(d + 2) % l])),
                    (e = f.GetTriangle(e)),
                    g &&
                        ((e.n0 = b[0]),
                        (e.n1 = b[(d + 1) % l]),
            ...
            if (void 0 !== c) {
                ...
                if (!(0 > c || c >= b.length))
                    return (
                        (b = b[c]),
                        0 === f
                            ? (g = a.AddVertex(b.x, b.y, b.z))
                            : 1 === f
                              ? (g = a.AddNormal(b.x, b.y, b.z))
                              : 2 === f && (g = a.AddUV(b.x, b.y)),
                        (d[c] = g)
                    );
            }
        }
...
JSM.ImportFileList.prototype.GetInputList = function() {
    ...
    for (b = 0; b < this.descriptors.length; b++) {
        ...
        d = { originalObject: d, isFile: e, isArrayBuffer: c };
        a.push(d);
    }
    return a;
};
...
JSM.ConvertImportFileListToJsonData = function(a, b) {
    ...
    function e(a, b, c, d) {
        ...
        a = a.GetFileName(c);
        if (-1 == e) return d.missing.push(a), null;
    ...
    if (-1 === f) c();
        ...
        var g = a.GetFileDescriptor(f),
            h = { main: g.originalFileName, requested: [], missing: [] },
            k = a.GetInputList();
        try {
            ".3DS" == g.extension
                ? JSM.LoadMultipleBuffers(k, function(b) {
...
JSM.WebGLInitShaderProgram = function(a, b, c, d) {
    function e(a, b, c, d) {
        ...
        return !a.getShaderParameter(c, a.COMPILE_STATUS)
            ? (void 0 !== d && null !== d && d(a.getShaderInfoLog(c)), null)
            : c;
    }
    b = (function(a, b, c, d) {
...
JSM.RenderMesh.prototype.GetVertex = function(a) {
    return new JSM.Coord(
        this.vertexArray[3 * a],
        this.vertexArray[3 * a + 1],
        this.vertexArray[3 * a + 2]
    );
};
...
JSM.RenderBody.prototype.AddMesh = function(a) {
    void 0 === this.meshes[a.material.type] &&
        (this.meshes[a.material.type] = []);
...
JSM.RenderBody.prototype.EnumerateMeshesWithFlag = function(a, b) {
    for (var c in this.meshes)
        this.meshes.hasOwnProperty(c) &&
            c & a &&
            this.EnumerateTypedMeshes(c, b);
};
...
JSM.ShaderType = { Point: 0, Line: 1, Triangle: 2, TexturedTriangle: 3 };
...
JSM.ShaderProgram.prototype.InitGlobalParams = function() {
    this.globalParams = {
        noDirectionalLight: new JSM.RenderDirectionalLight(
            0,
            0,
            new JSM.Vector(0, 0, 0)
        ),
        maxLightCount: 4
    };
    return !0;
...
JSM.ShaderProgram.prototype.InitShaders = function() {
    function a(a, b) {
        ...
        if (a == JSM.ShaderType.Point || a == JSM.ShaderType.Line)
            c = [
                "#define MAX_LIGHTS " + b.maxLightCount,
            ...
            a == JSM.ShaderType.Triangle ||
            a == JSM.ShaderType.TexturedTriangle
        )
            c = [
                "#define " +
                    (a == JSM.ShaderType.Triangle ? "NOTEXTURE" : "USETEXTURE"),
                "#define MAX_LIGHTS " + b.maxLightCount,
    ...
    function b(a) {
        ...
        if (
            ...
            b = [
                "#define " + (a == JSM.ShaderType.Point ? "POINT" : "LINE"),
    ...
    function c(a, b, c, d) {
        if (
            d == JSM.ShaderType.Triangle ||
            d == JSM.ShaderType.TexturedTriangle
        ) {
            b.vertexPositionAttribute = a.getAttribLocation(
                b,
                "aVertexPosition"
            );
            b.vertexNormalAttribute = a.getAttribLocation(b, "aVertexNormal");
            b.ambientLightColorUniform = a.getUniformLocation(
                b,
                "uAmbientLightColor"
            );
            b.lightUniforms = [];
            ...
            for (k = 0; k < c.maxLightCount; k++)
                b.lightUniforms.push({
                    diffuseColor: a.getUniformLocation(
                        b,
                        "uLights[" + k + "].diffuseColor"
                    ),
                    specularColor: a.getUniformLocation(
                        b,
                        "uLights[" + k + "].specularColor"
                    ),
                    direction: a.getUniformLocation(
                        b,
                        "uLights[" + k + "].direction"
                    )
                });
            ...
            d == JSM.ShaderType.TexturedTriangle &&
                ((b.vertexUVAttribute = a.getAttribLocation(b, "aVertexUV")),
            ...
            b.pMatrixUniform = a.getUniformLocation(b, "uProjectionMatrix");
            b.tMatrixUniform = a.getUniformLocation(b, "uTransformationMatrix");
            d == JSM.ShaderType.Point &&
                (b.pointSizeUniform = a.getUniformLocation(b, "uPointSize"));
        }
    }
    function d(d, f, g, h) {
        var k = b(h),
    ...
    if (
        ...
        !d(
            ...
            this.shaders,
            this.globalParams,
            JSM.ShaderType.Triangle
        ) ||
        !d(
            this.context,
            this.shaders,
            this.globalParams,
            JSM.ShaderType.TexturedTriangle
        )
    )
        return !1;
...
JSM.ShaderProgram.prototype.SetParameters = function(a, b, c, d) {
    var e = this.context,
        ...
        h;
    if (
        this.currentType == JSM.ShaderType.Triangle ||
        this.currentType == JSM.ShaderType.TexturedTriangle
    ) {
        e.uniform3f(
            f.ambientLightColorUniform,
            a.color[0],
            a.color[1],
            a.color[2]
        );
        for (a = 0; a < this.globalParams.maxLightCount; a++)
            (g = a < b.length ? b[a] : this.globalParams.noDirectionalLight),
                ...
                e.uniform3f(
                    f.lightUniforms[a].diffuseColor,
                    g.diffuse[0],
                    g.diffuse[1],
                    g.diffuse[2]
                ),
                e.uniform3f(
                    f.lightUniforms[a].specularColor,
                    g.specular[0],
                    g.specular[1],
                    g.specular[2]
                ),
        ...
        this.currentType == JSM.ShaderType.Point ||
        this.currentType == JSM.ShaderType.Line
    ) {
        e.uniform3f(
            f.ambientLightColorUniform,
            a.color[0],
...
JSM.ShaderProgram.prototype.SetCullEnabled = function(a) {
    a && !this.cullEnabled
        ? (this.context.enable(this.context.CULL_FACE), (this.cullEnabled = !0))
        : !a &&
          this.cullEnabled &&
          (this.context.disable(this.context.CULL_FACE),
          (this.cullEnabled = !1));
...
JSM.ShaderProgram.prototype.DrawArrays = function(a, b, c, d, e) {
    ...
    if (
        ...
        f.uniform3f(
            g.materialUniforms.ambientColor,
            a.ambient[0],
            a.ambient[1],
            a.ambient[2]
        ),
            f.uniform3f(
                g.materialUniforms.diffuseColor,
                a.diffuse[0],
                a.diffuse[1],
                a.diffuse[2]
            ),
            f.uniform3f(
                g.materialUniforms.specularColor,
                a.specular[0],
                a.specular[1],
                a.specular[2]
            ),
        ...
        f.uniform3f(
            ...
            this.currentType == JSM.ShaderType.Point
                ? (f.uniform1f(g.pointSizeUniform, a.pointSize),
                  f.drawArrays(f.POINTS, 0, c.numItems))
                : this.currentType == JSM.ShaderType.Line &&
                  f.drawArrays(f.LINES, 0, c.numItems);
};
...
JSM.Renderer.prototype.FindObjects = function(a, b, c) {
    ...
    this.EnumerateBodies(function(a) {
        ...
        a.EnumerateMeshesWithFlag(JSM.RenderMaterialFlags.Triangle, function(
            c
        ) {
            var k = c.VertexCount(),
                l,
            ...
            for (l = 0; l < k; l += 3)
                (m = c.GetTransformedVertex(l + 0, b)),
                    ...
                    (p = c.GetTransformedVertex(l + 2, b)),
                    (m = JSM.RayTriangleIntersection(d, m, n, p)),
                    null !== m &&
                        e.push({
                            renderBody: a,
                            renderMesh: c,
...
JSM.Renderer.prototype.Render = function(a) {
    ...
    b(
        this,
        JSM.RenderMaterialFlags.Triangle + JSM.RenderMaterialFlags.Textured,
        c,
        a
    );
    ...
    b(
        this,
        JSM.RenderMaterialFlags.Triangle + JSM.RenderMaterialFlags.Transparent,
        c,
        a
    );
    b(
        this,
        JSM.RenderMaterialFlags.Triangle +
            JSM.RenderMaterialFlags.Transparent +
            JSM.RenderMaterialFlags.Textured,
        c,
        a
    );
};
...
JSM.PointCloudRenderer.prototype.InitShaders = function() {
    ...
    if (
        !this.context.getProgramParameter(this.shader, this.context.LINK_STATUS)
    )
        return !1;
    this.context.useProgram(this.shader);
    this.shader.vertexPositionAttribute = this.context.getAttribLocation(
        this.shader,
        "aVertexPosition"
    );
    this.context.enableVertexAttribArray(this.shader.vertexPositionAttribute);
    this.shader.vertexColorAttribute = this.context.getAttribLocation(
        this.shader,
        "aVertexColor"
    );
    this.context.enableVertexAttribArray(this.shader.vertexColorAttribute);
    this.shader.pMatrixUniform = this.context.getUniformLocation(
        this.shader,
        "uProjectionMatrix"
    );
    this.shader.vMatrixUniform = this.context.getUniformLocation(
        this.shader,
        "uViewMatrix"
    );
    this.shader.pointSizeUniform = this.context.getUniformLocation(
        this.shader,
        "uPointSize"
    );
    return !0;
...
JSM.PointCloudRenderer.prototype.AddPoints = function(a, b) {
    ...
    this.points.push({ pointArray: d, pointBuffer: c, colorBuffer: e });
};
...
JSM.PointCloudRenderer.prototype.Render = function() {
    ...
    var a = JSM.MatrixPerspective(
        this.camera.fieldOfView * JSM.DegRad,
        this.canvas.width / this.canvas.height,
...
JSM.ConvertBodyToRenderBody = function(a, b, c) {
    ...
    void 0 !== c &&
        null !== c &&
        (void 0 !== c.hasConvexPolygons && null !== c.hasConvexPolygons) &&
        (e = c.hasConvexPolygons);
    ...
    JSM.ExplodeBody(a, b, {
        ...
        onTriangle: function(a, b, c, d, e, f, s, v, u) {
            ...
            null !== s &&
                (null !== v && null !== u) &&
                (k.push(s.x, s.y), k.push(v.x, v.y), k.push(u.x, u.y));
        }
    });
    return f;
};
...
JSM.ConvertJSONDataToRenderBodies = function(a, b) {
    function c(a, b) {
        ...
        for (e = 0; e < a.triangles.length; e++)
            (f = a.triangles[e]), (f = c(a, f, b)), d.AddMesh(f);
        return d;
    }
    var d = [],
        e = a.materials;
...
JSM.Mouse.prototype.SetCurrent = function(a, b) {
    var c = a.clientX,
        d = a.clientY;
    void 0 !== b &&
        (void 0 !== b.offsetLeft && void 0 !== b.offsetTop) &&
...
JSM.Touch.prototype.SetCurrent = function(a, b) {
    function c(a) {
        ...
        return new JSM.Coord2D(c, a);
    }
    if (1 == a.touches.length || 3 == a.touches.length)
        this.curr = c(a.touches[0]);
    else if (2 == a.touches.length) {
        var d = c(a.touches[0]).DistanceTo(c(a.touches[1]));
    ...
    (function() {
        ...
        for (l = 0; l < a.PolygonCount(); l++) {
            ...
            for (t = 0; t < m.VertexIndexCount(); t++)
                (w = a.GetVertexPosition(m.GetVertexIndex(t))),
                    (n = JSM.CoordAdd(n, w));
    ...
    (function() {
        ...
        for (b = 0; b < a - 1; b++)
            for (c = 0; c < a - b - 1; c++) {
                ...
                d = k[c];
                var f = k[c + 1];
                d = JSM.IsLower(e[d], e[f])
                    ? !0
                    : JSM.IsEqual(e[d], e[f]) && JSM.IsLower(g[d], g[f])
                      ? !0
                      : !1;
                if (d) {
                    d = k;
                    ...
                    if ((n = JSM.IsLowerOrEqual(d[g], e[m]))) {
                        ...
                        for (
                            var A = h[p],
                                ...
                                z = a.GetPolygon(g),
                                B = 0;
                            B < z.VertexIndexCount();
                            B++
                        )
                            if (
                                ((x = a.GetVertexPosition(z.GetVertexIndex(B))),
                                A.CoordPosition(x) ===
                                    JSM.CoordPlanePosition.CoordInFrontOfPlane)
                            ) {
                                y = !1;
                        ...
                        if (y) n = !1;
                            ...
                            A = !0;
                            p = a.GetPolygon(p);
                            for (B = 0; B < p.VertexIndexCount(); B++)
                                if (
                                    ((x = a.GetVertexPosition(
                                        p.GetVertexIndex(B)
                                    )),
                                    n.CoordPosition(x) ===
                                        JSM.CoordPlanePosition
...
JSM.CanvasDrawer.prototype.DrawPolygon = function(a, b, c) {
    ...
    for (d = 0; d < a.VertexCount(); d++)
        (b = a.GetVertex(d)),
            0 === d
                ? this.context.moveTo(b.x, this.canvas.height - b.y)
                : this.context.lineTo(b.x, this.canvas.height - b.y);
...
JSM.DrawProjectedBody = function(a, b, c, d, e, f) {
    function g(a, b) {
        var c = JSM.Project(b, l, m, n, p * JSM.DegRad, q, r, s, v);
        a.AddVertex(c.x, c.y);
    }
    function h(b) {
    ...
    if ("HiddenLinePainter" == d) {
        ...
        for (c = 0; c < a.PolygonCount(); c++)
            (u = a.GetPolygon(c)),
                (t = h(u)),
                t.GetOrientation() == JSM.Orientation.CounterClockwise &&
                    ((w = u.GetMaterialIndex()),
                    (A = b.GetMaterial(w).diffuse),
                    f.DrawPolygon(t, A, !0));
    } else if ("Wireframe" == d) {
        ...
        for (c = 0; c < a.PolygonCount(); c++) {
            ...
            for (d = 0; d <= k; d++)
                (y = u.GetVertexIndex(d % k)),
                    (e = a.GetVertexPosition(y)),
                    (t = JSM.Project(e, l, m, n, p * JSM.DegRad, q, r, s, v)),
                    null !== B &&
                        (null !== x && void 0 === z[[x, y]]) &&
                        (f.DrawLine(B, t), (z[[x, y]] = !0), (z[[y, x]] = !0)),
                    (x = y),
                    (B = t);
        }
    }
...
JSM.Navigation.prototype.FitInWindow = function(a, b) {
    if (!JSM.IsZero(b)) {
        ...
        this.canvas.width < this.canvas.height &&
            (d = d * this.canvas.width / this.canvas.height);
...
JSM.Navigation.prototype.Orbit = function(a, b) {
    ...
    this.cameraFixUp
        ? ((e = e.AngleTo(this.camera.up) + d),
          JSM.IsGreater(e, 0) &&
              JSM.IsLower(e, Math.PI) &&
          ...
          g && this.camera.center.Rotate(this.camera.up, -c, this.orbitCenter))
        : ((e = JSM.VectorCross(f, e).Normalize()),
          this.camera.eye.Rotate(f, -d, this.orbitCenter),
          this.camera.eye.Rotate(e, -c, this.orbitCenter),
          g &&
              (this.camera.center.Rotate(f, -d, this.orbitCenter),
...
JSM.Navigation.prototype.Zoom = function(a) {
    ...
    if (
        (d &&
            null !== this.cameraNearDistanceLimit &&
            c < this.cameraNearDistanceLimit) ||
        (!d &&
            null !== this.cameraFarDistanceLimit &&
            c > this.cameraFarDistanceLimit)
    )
        return 0;
    this.camera.eye.Offset(b, c * a);
};
JSM.Navigation.prototype.DrawCallback = function() {
    void 0 !== this.drawCallback &&
        null !== this.drawCallback &&
        this.drawCallback();
};
JSM.Navigation.prototype.ResizeCallback = function() {
    void 0 !== this.resizeCallback &&
        null !== this.resizeCallback &&
        (this.fullscreen &&
...
JSM.SoftwareViewer.prototype.InitCanvas = function(a) {
    ...
    this.canvas instanceof HTMLCanvasElement
        ...
        : this.canvas instanceof SVGSVGElement &&
...
JSM.SpriteViewer.prototype.Start = function(a, b, c) {
    return !this.InitCanvas(a) || !this.InitCamera(b) || !this.InitCallbacks(c)
        ? !1
        : !0;
};
...
JSM.SpriteViewer.prototype.InitCamera = function(a) {
    ...
    if (!this.camera) return !1;
    this.navigation = new JSM.Navigation();
    return !this.navigation.Init(this.canvas, this.camera, this.Draw.bind(this))
        ? !1
        : !0;
};
JSM.SpriteViewer.prototype.InitCallbacks = function(a) {
    this.callbacks = { onPointDraw: null };
    void 0 !== a &&
        (void 0 !== a.onDrawStart &&
            (this.callbacks.onDrawStart = a.onDrawStart),
        void 0 !== a.onPointDraw &&
            (this.callbacks.onPointDraw = a.onPointDraw),
...
JSM.SpriteViewer.prototype.NearestPointUnderPosition = function(a, b, c) {
    ...
    for (e = 0; e < this.projected.length; e++)
        (f = this.projected[e]),
            ...
            JSM.IsLower(g, a) &&
                JSM.IsLower(g, d) &&
                ((c = f.originalIndex), (d = g));
    return c;
};
JSM.SpriteViewer.prototype.NearestPointUnderMouse = function(a) {
    return this.NearestPointUnderPosition(
        a,
        this.navigation.mouse.curr.x,
        this.navigation.mouse.curr.y
    );
};
JSM.SpriteViewer.prototype.NearestPointUnderTouch = function(a) {
    return this.NearestPointUnderPosition(
        a,
        this.navigation.touch.curr.x,
        this.navigation.touch.curr.y
    );
};
...
JSM.SpriteViewer.prototype.Draw = function() {
    ...
    this.projected.sort(function(a, b) {
        return a.position.z > b.position.z
            ? -1
            : a.position.z < b.position.z ? 1 : 0;
    });
    for (c = 0; c < this.projected.length; c++)
        if (null !== this.callbacks.onPointDraw)
            this.callbacks.onPointDraw(
                this.canvas,
                this.projected[c].originalIndex,
                this.projected[c].position
            );
...
JSM.Viewer.prototype.Init = function(a, b) {
    return !this.InitRenderer(a) ||
    !this.InitNavigation(b) ||
    !this.InitLights()
        ? !1
        : !0;
};
...
JSM.Viewer.prototype.EnableCameraLight = function() {
    null === this.cameraLight &&
        ((this.cameraLight = new JSM.RenderDirectionalLight(
            8355711,
            16777215,
            new JSM.Vector(1, 0, 0)
        )),
        this.AddLight(this.cameraLight));
};
JSM.Viewer.prototype.DisableCameraLight = function() {
    null !== this.cameraLight &&
        (this.RemoveLight(this.cameraLight), (this.cameraLight = null));
};
...
JSM.GenerateSolidWithRadius = function(a, b) {
    var c = new JSM.Body(),
        d = !0;
    "Tetrahedron" === a
        ? (c = JSM.GenerateTetrahedron())
        : "Hexahedron" === a
          ? (c = JSM.GenerateHexahedron())
          : "Octahedron" === a
            ? (c = JSM.GenerateOctahedron())
            : "Dodecahedron" === a
              ? (c = JSM.GenerateDodecahedron())
              : "Icosahedron" === a
                ? (c = JSM.GenerateIcosahedron())
                : "TruncatedTetrahedron" === a
                  ? (c = JSM.GenerateTruncatedTetrahedron())
                  : "Cuboctahedron" === a
                    ? (c = JSM.GenerateCuboctahedron())
                    : "TruncatedCube" === a
                      ? (c = JSM.GenerateTruncatedCube())
                      : "TruncatedOctahedron" === a
                        ? (c = JSM.GenerateTruncatedOctahedron())
                        : "Rhombicuboctahedron" === a
                          ? (c = JSM.GenerateRhombicuboctahedron())
                          : "TruncatedCuboctahedron" === a
                            ? (c = JSM.GenerateTruncatedCuboctahedron())
                            : "SnubCube" === a
                              ? (c = JSM.GenerateSnubCube())
                              : "Icosidodecahedron" === a
                                ? (c = JSM.GenerateIcosidodecahedron())
                                : "TruncatedDodecahedron" === a
                                  ? (c = JSM.GenerateTruncatedDodecahedron())
                                  : "TruncatedIcosahedron" === a
                                    ? (c = JSM.GenerateTruncatedIcosahedron())
                                    : "Rhombicosidodecahedron" === a
                                      ? (c = JSM.GenerateRhombicosidodecahedron())
                                      : "TruncatedIcosidodecahedron" === a
                                        ? (c = JSM.GenerateTruncatedIcosidodecahedron())
                                        : "SnubDodecahedron" === a
                                          ? (c = JSM.GenerateSnubDodecahedron())
                                          : "TetrakisHexahedron" === a
                                            ? ((c = JSM.GenerateTetrakisHexahedron()),
                                              (d = !1))
                                            : "RhombicDodecahedron" === a
                                              ? ((c = JSM.GenerateRhombicDodecahedron()),
                                                (d = !1))
                                              : "PentakisDodecahedron" === a
                                                ? ((c = JSM.GeneratePentakisDodecahedron()),
                                                  (d = !1))
                                                : "SmallStellatedDodecahedron" ===
                                                  a
                                                  ? ((c = JSM.GenerateSmallStellatedDodecahedron()),
                                                    (d = !1))
                                                  : "GreatDodecahedron" === a
                                                    ? ((c = JSM.GenerateGreatDodecahedron()),
                                                      (d = !1))
                                                    : "SmallTriambicIcosahedron" ===
                                                      a
                                                      ? ((c = JSM.GenerateSmallTriambicIcosahedron()),
                                                        (d = !1))
                                                      : "GreatStellatedDodecahedron" ===
                                                        a
                                                        ? ((c = JSM.GenerateGreatStellatedDodecahedron()),
                                                          (d = !1))
                                                        : "SmallTriakisOctahedron" ===
                                                          a
                                                          ? ((c = JSM.GenerateSmallTriakisOctahedron()),
                                                            (d = !1))
                                                          : "StellaOctangula" ===
                                                            a
                                                            ? ((c = JSM.GenerateStellaOctangula()),
                                                              (d = !1))
                                                            : "TriakisTetrahedron" ===
                                                                  a &&
                                                              ((c = JSM.GenerateTriakisTetrahedron()),
                                                              (d = !1));
    if (0 < c.VertexCount()) {
        var e = 0;
        ...
        for (d = 0; d < c.VertexCount(); d++)
            (f = c.GetVertex(d)), f.position.MultiplyScalar(e);
    }
    return c;
};
...
JSM.GenerateSnubCube = function() {
    var a = new JSM.Body(),
        b =
            1 /
            3 *
            (Math.pow(17 + 3 * Math.sqrt(33), 1 / 3) -
                Math.pow(-17 + 3 * Math.sqrt(33), 1 / 3) -
                1),
        c = 1 / b;
    JSM.AddVertexToBody(a, 1, +b, -c);
...
JSM.GenerateSnubDodecahedron = function() {
    var a = new JSM.Body(),
        b = (1 + Math.sqrt(5)) / 2,
        c =
            Math.pow(b / 2 + 0.5 * Math.sqrt(b - 5 / 27), 1 / 3) +
            Math.pow(b / 2 - 0.5 * Math.sqrt(b - 5 / 27), 1 / 3),
        d = c - 1 / c,
    ...
    JSM.AddVertexToBody(a, +n, -l, +m);
    JSM.AddVertexToBody(a, -n, -l, -m);
    JSM.AddVertexToBody(a, +p, +q, -r);
    JSM.AddVertexToBody(a, +p, -q, +r);
    JSM.AddVertexToBody(a, -p, +q, +r);
    JSM.AddVertexToBody(a, -p, -q, -r);
    JSM.AddVertexToBody(a, +q, -r, +p);
    JSM.AddVertexToBody(a, -q, +r, +p);
    JSM.AddVertexToBody(a, +q, +r, -p);
    JSM.AddVertexToBody(a, -q, -r, -p);
    JSM.AddVertexToBody(a, -r, +p, +q);
    JSM.AddVertexToBody(a, +r, +p, -q);
    JSM.AddVertexToBody(a, +r, -p, +q);
    JSM.AddVertexToBody(a, -r, -p, -q);
...
JSM.GenerateLegoBrick = function(a, b, c, d, e, f, g) {
    ...
    if (d)
        for (t = 0; t < a; t++)
            for (u = 0; u < b; u++)
                (d = new JSM.Coord(m * t + m / 2, m * u + m / 2, n + q / 2)),
                    (l = JSM.GenerateCylinder(p / 2, q, f, !0, g)),
                    h(l, d),
                    k.Merge(l);
    if (e)
        if ((1 === a && 1 < b) || (1 === b && 1 < a)) {
            ...
            for (t = 0; t < e - 1; t++)
                (d = p
                    ? new JSM.Coord(m / 2, m * (t + 1), (n - c) / 2)
                    : new JSM.Coord(m * (t + 1), m / 2, (n - c) / 2)),
...
JSM.GenerateSuperShape = function(a, b, c, d, e, f, g, h, k, l, m, n, p, q) {
    ...
    function v(q, p) {
        var r = new JSM.Coord(0, 0, 0),
            t = s(q, g, h, k, l, m, n),
            u = s(p, a, b, c, d, e, f);
        r.x = u * Math.cos(p) * t * Math.cos(q);
        r.y = u * Math.sin(p) * t * Math.cos(q);
        r.z = t * Math.sin(q);
        return r;
    }
    p = JSM.GenerateSphere(1, p, q);
    var u, t;
    ...
    (function(a, b, c, d) {
        ...
        for (e = 0; e < c.pgons.length; e++) {
            ...
            for (m = 0; m < n.verts.length; m++)
                (p = a.GetVertexPosition(n.verts[m])), (q = JSM.CoordAdd(q, p));
            q.MultiplyScalar(1 / n.verts.length);
            d.push(b.AddVertex(new JSM.BodyVertex(q)));
        }
    })(a, b, c, d);
    (function(a, b, c, d, e) {
        var m, n, p, q, r;
        for (m = 0; m < c.edges.length; m++) {
            p = c.edges[m];
            n = a.GetVertexPosition(p.vert1);
            q = a.GetVertexPosition(p.vert2);
            if (c.IsContourEdge(p)) q = JSM.MidCoord(n, q);
            else {
                q = JSM.CoordAdd(n, q);
                for (n = 0; 2 > n; n++)
                    (r = 0 === n ? p.pgon1 : p.pgon2),
                        (r = b.GetVertexPosition(d[r])),
                        (q = JSM.CoordAdd(q, r));
                q.MultiplyScalar(0.25);
            }
            e.push(b.AddVertex(new JSM.BodyVertex(q)));
        }
    })(a, b, c, d, e);
    (function(a, b, c, d) {
        function e(a, b) {
        ...
        var n = [],
            p,
            q;
        for (q = 0; q < c.edges.length; q++)
            (p = c.edges[q]),
                (p = JSM.MidCoord(
                    a.GetVertexPosition(p.vert1),
                    a.GetVertexPosition(p.vert2)
                )),
                n.push(p);
        var r, s, v, u;
        for (q = 0; q < c.verts.length; q++)
            if (
                ((r = c.verts[q]),
                (s = b.GetVertexPosition(q)),
                c.IsContourVertex(r))
            ) {
                v = 0;
                ...
                for (a = 0; a < r.edges.length; a++)
                    (p = r.edges[a]),
                        c.IsContourEdge(c.edges[p]) &&
                            ((p = n[r.edges[a]]), u.Add(p), v++);
                u.Add(s);
                v++;
                ...
                for (a = 0; a < r.pgons.length; a++)
                    (p = r.pgons[a]), (p = b.GetVertexPosition(d[p])), v.Add(p);
                v.MultiplyScalar(1 / r.pgons.length);
                for (a = 0; a < r.edges.length; a++)
                    (p = r.edges[a]), (p = n[p]), u.Add(p);
        ...
        for (s = 0; s < c.pgons.length; s++) {
            ...
            for (v = 0; v < m; v++)
                (n = u.pedges[v]),
                    ...
                    (q = d[s]),
                    (n = e[n.index]),
                    (r = c.GetPolyEdgeStartVertex(p)),
                    (p = e[p.index]),
                    (q = new JSM.BodyPolygon([q, n, r, p])),
                    (p = a.GetPolygon(s)),
...
JSM.BooleanOperation = function(a, b, c) {
    ...
    function f(a, b, c, d, e, f) {
        function g(a, b) {
            var c;
            for (c = 0; c < a.length; c++) a[c].userData = b;
        }
        var h, k;
        for (h = 0; h < a.length; h++)
            (k = a[h]),
    ...
    "Union" == a
        ? (e(k, g, b, !1),
          ...
          e(r, g, b, !1))
        : "Difference" == a
          ? (e(k, g, b, !1), e(m, g, b, !1), e(q, g, b, !0))
          : "Intersection" == a &&
            (e(l, g, b, !1), e(n, g, b, !1), e(q, g, b, !1));
    return g;
};
        ...
        for (g = 0; g < d; g++)
            for (b = 0; b < c; b++)
                (h = g * (c + 1) + b),
                    ...
                    (s = r + 1),
                    e
                        ? ((k = new JSM.BodyPolygon([h, k, s])),
                          f && k.SetCurveGroup(0),
                          a.AddPolygon(k),
                          (k = new JSM.BodyPolygon([h, s, r])))
                        : (k = new JSM.BodyPolygon([h, k, s, r])),
                    f && k.SetCurveGroup(0),
                    a.AddPolygon(k);
    })(k);
    return k;
    ...
    return JSM.GenerateSurface(
        ...
        function(a, b, c, d, k) {
            ...
            for (a = 0; a <= p; a++) {
                ...
                for (b = 0; b <= q; b++)
                    (n =
                        JSM.BernsteinPolynomial(a, p, c) *
                        JSM.BernsteinPolynomial(b, q, d)),
                        (n = k
                            .GetControlPoint(a, b)
                            .Clone()
                            .MultiplyScalar(n)),
